$(function() {
	...
	$(document).ready(function() {
	  ...
	  $('#property_accommodation_list_div').on("click", '#rom-up', function() {
		guestAmount.val(Math.min(parseInt($('#roomNo').val()) +1, 20));
	  });
	  $('#property_accommodation_list_div').on('click', '#rom-down', function() {
	...
	$(document).ready(function() {
	  ...
	  $('#property_accommodation_list_div').on('click', '#krom-up', function() {
		guestAmount.val(Math.min(parseInt($('#kidsroomNo').val()) + 1, 20));
	  });
	  $('#property_accommodation_list_div').on('click', '#krom-down', function() {
	...
	$(document).ready(function() {
		...
		var newdate_venue = new Date();
		newdate_venue.setDate(newdate_venue.getDate() + 365);
		var nd_venue = new Date(newdate_venue);
		// Daterange Script

		$('#date_range,#checkInOut').daterangepicker({
				"autoApply": true,
				"minDate": new Date(),
				"maxDate": nd,
					"locale": {
		...
		$('#checkInOut_venue').daterangepicker({
			"autoApply": true,
			"minDate": new Date(),
			"maxDate": nd_venue,
				"locale": {
		...
		$('#checkInOut_venue').on('apply.daterangepicker', function(ev, picker) {

			//$(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));

			$("#checkindt_venue").val(picker.startDate.format('DDMMYYYY'));
			$("#checkoutdt_venue").val(picker.endDate.format('DDMMYYYY'));
		});

		// Initialize with a default 10-day range
		/*const endDate = moment();
		const startDate = moment().subtract(9, 'days');
	
		$('#checkInOut_venue').data('daterangepicker').setStartDate(startDate);
		$('#checkInOut_venue').data('daterangepicker').setEndDate(endDate);*/
	
		// Trigger the 'apply.daterangepicker' event
		//$('#checkInOut_venue').trigger('apply.daterangepicker');
	...
	// Check In & Check Out Daterange Script
	$(function() {
		$('input[name="checkout_venue"]').daterangepicker({
		  singleDatePicker: true,
		});
		  $('input[name="checkout_venue"]').val('');
		  $('input[name="checkout_venue"]').attr("placeholder","Check Out");
	  });
	  
	  $(function() {
		$('input[name="checkin_venue"]').daterangepicker({
		  singleDatePicker: true,
		  
		});
		  $('input[name="checkin_venue"]').val('');
		  $('input[name="checkin_venue"]').attr("placeholder","Check In");
	  });
