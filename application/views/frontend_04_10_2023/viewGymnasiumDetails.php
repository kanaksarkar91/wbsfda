    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h1><?php echo $facilities['sports_facilities_name']?></h1>
            </div>
                ...
                <div class="owl-carousel owl-theme owl_acitivity">
                    <?php if(isset($facilitY_images) && $facilitY_images): foreach($facilitY_images as $key=>$image):?> 
                        <div class="item wow <?php ($key%2)?'bounceInUp':'bounceInDown'?>">
                            <article>
                                <div class="image"> <img src="<?php echo base_url()?>public/admin_images/sports_facilities/<?php echo $image['sports_facilities_image_file']?>" alt="" title=""> </div>
                                <div class="details">
                                    <div class="text text-center">
                                        <h3 class="title"><a href="javascript:void(0);">Gymnasium View</a></h3>
                                    </div>
                                </div>
                            </article>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8 col-md-offset-2 text-left">
                <table class="m_top20 table table-bordered">
                    ...
                    <tr>
                        <th>Address :</th>
                        <td><?php echo $facilities['address']?></td>
                    </tr>
                    <tr>
                        <th>Contact No. :</th>
                        <td><?php echo $facilities['contact_no']?></td>
                    </tr>
                    <tr>
                        <th>e-mail ID :</th>
                        <td><?php echo $facilities['email']?></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php if(count($facilities['amenitis']) > 0):?>
                                <?php foreach($facilities['amenitis'] as $amenity):?>
                                    <?php echo $amenity['facilities_amenitis_name']?>,
                                <?php endforeach?>
                            <?php endif?>
                        </td>
                    </tr>
                        ...
                        <td>
                            <?php if(count($facilities['infrastructure']) > 0):?>
                                <?php foreach($facilities['infrastructure'] as $infrastructure):?>
                                    <?php echo $infrastructure['sports_infrastructure_name']?>,
                                <?php endforeach?>
                            <?php endif?>
                        </td>
                    </tr>
            ...
            <div class="col-sm-12 text-center m_bot20">
                <?php if($this->session->userdata('logged_in') && $this->session->userdata('user_type') == 'frontend'):?>
                    <a class="btn btn-main btn_select" href="<?php echo base_url()?>create-profile?source=gymnasium">Apply for membership</a>
                <?php else:?>
                    <a class="btn btn-main btn_select" href="#" data-toggle="modal" data-target="#LoginModal">Login/Sign Up for membership</a>
                <?php endif?>
            </div>
            <div class="col-sm-12 text-center">
