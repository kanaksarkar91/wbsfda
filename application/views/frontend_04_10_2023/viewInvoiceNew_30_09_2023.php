...
<body role="document">
	<table id="printArea" cellpadding="0" cellspacing="0" border="0" style="width: 90%;; margin: 0 auto; font-family: Verdana, Geneva, Tahoma, sans-serif;font-size: 11px;border:#9e9e9e 1px solid; padding: 15px;text-align: center;">
	    <style type="text/css">
                                        body,
                                        p,
                                        ol,
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;margin-bottom: 0px;">
					<tr>
						<td width="27%" style="text-align: left;padding:15px;">
							<img src="https://panchayet.syscentricdev.com/public/frontend_assets/images/logo_book.png" alt="" width="65px">
						</td>
						...
						<td width="25%" style="text-align: center;">
							<h3 style="font-size:16px;margin-bottom: 12px;"><b>SFDC</b></h3>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; margin-top: 10px; font-size: 12px;">
					...
					<tr>
						...
						<td width="9%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: center;" rowspan="2"><?=$booking_detail['room_rate'] ?></td>
						...
						<td width="9%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: center;" rowspan="2"><?=$booking_detail['room_taxable_amount'] + (($booking_detail['room_taxable_amount'] * $booking_detail['gst_perc'])/100) ?></td> -->
					</tr>
					<tr>
						...
						<!-- <td  style="padding: 3px;border-right: #9e9e9e 1px solid;border-bottom: #9e9e9e 1px solid;text-align: center;"><?=($booking_detail['room_taxable_amount'] * $booking_detail['gst_perc'])/100?></td> -->
					...
					<tr>
						...
						<td width="9%" style="background-color:#d9d9d9;border-right: #9e9e9e 1px solid;padding: 3px;text-align: center;"><b><?=number_format((float)$totalRoomRate, 2, '.', '')?></b></td>
						<td width="15%" style="background-color:#d9d9d9;padding: 3px;border-right: #9e9e9e 1px solid;text-align: center;"><b><?=number_format((float)$totalExtraBedRate, 2, '.', '')?></b></td>
						...
						<td width="9%" style="background-color:#d9d9d9;border-right: #9e9e9e 1px solid;padding: 3px;text-align: center;"><b><?=number_format((float)$totalPayableAmount, 2, '.', '')?></b></td>
					</tr>
				</table>
			</td>
		</tr>
