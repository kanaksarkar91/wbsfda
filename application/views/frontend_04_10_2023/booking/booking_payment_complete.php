						...
						<div class="row mb-5">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 text-center">
								<div style="width: 80%; margin:0 auto; padding-top: 30px;" class="text-center">
									...
									<h4 class="text-success">Congratulations! Your Payment Successful and Booking is confirmed.<br><br><?= isset($booking_det->booking_no) && $booking_det->booking_no != '' ? 'Your Booking No. ' . $booking_det->booking_no : ''; ?></h4>
...
<div class="modal hide fade" id="paymentstatusModal">
    ...
    <div class="modal-body">
        <?php if ($status == 'SUCCESS') { ?>
		<h6 class="text-success">Congratulations! Your Payment is Successful and Booking Confirmed.<br><br><?= isset($booking_det->booking_no) && $booking_det->booking_no != '' ? 'Booking No. ' . $booking_det->booking_no : ''; ?><?= isset($booking_det->transaction_ref_id) && $booking_det->transaction_ref_id != '' ? '<br>Transaction Ref. No. ' . $booking_det->transaction_ref_id : ''; ?><?= isset($booking_det->amount) && $booking_det->amount != '' ? '<br>Amount ₹' . $booking_det->amount : ''; ?></h6>
		<?php } elseif ($status == 'FAILURE') { ?>
