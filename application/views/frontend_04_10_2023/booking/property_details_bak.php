		...
		<div class="row">
				...
				<div class="block-wrap">
					...
					<div class="details-contents-header">
						<div class="details-contents-thumb details-contents-main-thumb bg-image">
							<img src="<?= base_url('public/admin_images/' . $property['image1']); ?>" alt="img" class="img-fluid d-block mx-auto">
						</div>
						<div class="details-contents-header-flex">
							<div class="details-contents-header-thumb">
								<img src="<?= base_url('public/admin_images/' . $property['image2']); ?>" alt="img">
							</div>
							<div class="details-contents-header-thumb">
								<img src="<?= base_url('public/admin_images/' . $property['image3']); ?>" alt="img">
							</div>
						</div>
					</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="youtube_video">
					...
					<a href="<?php echo $property['youtube_video_link'];?>" target="_blank"><img src="https://img.youtube.com/vi/<?php echo $videoId; ?>/hqdefault.jpg" width="370" /></a>
				</div>
				<?php
				}
				?>
						...
						<div class="side-booking-body pb-0">
							...
							<div class="row mb-4">
								...
								<div class="col-lg-3 col-md-3 col-sm-6 border-right dropdown form-select-guests mnbr" <?= isset($property['property_type_id']) && in_array($property['property_type_id'], array(7,8,9,14)) ? 'style="display: none;"' : ''; ?>>
									<div class="form-group">
										<label>Guests</label>
										<div class="form-content dropdown-toggle" data-toggle="dropdown" style="height:39px!important; border: 2px solid #e6eaf3; padding:5px;">
							...
							<form action="<?php echo base_url('frontend/booking/init_booking');?>" method="post">
							<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
							<input type="hidden" name="property" value="<?= isset($property_id) && $property_id != '' ? $property_id : ''; ?>">
							<input type="hidden" name="rate_category" value="<?= isset($rate_category_id) && $rate_category_id != '' ? $rate_category_id : ''; ?>">
							<input type="hidden" name="stay_date" value="<?php echo $stayDates;?>"  />
							<input type="hidden" name="adult" value="<?php echo $adult_pax;?>"  />
							<input type="hidden" name="child" value="<?php echo $child_pax;?>"  />
							        ...
							        <div class="table-responsive">
										<table class="table table-hover table-bordered mb-0 room-type-tbl">
											...
											<tr>
												<td class="p-2">
													<div class="d-flex flex-column flex-md-row" data-toggle="modal" data-target="#accomodation_detailModal<?= $j; ?>">
														...
														<div class="media-body">
															...
															<?php if (isset($accommodation['adult']) || isset($accommodation['child'])) { ?>
																<p class="mb-1"><i class="fas fa-users thm-txt"></i> 
																<?php if (isset($property['property_type_id']) && in_array($property['property_type_id'], array(7,8,9,14))) { ?>
												...
												<td data-label="Price" class="p-1">₹ <?= isset($accommodation['base_price']) && $accommodation['base_price'] != '' ? $accommodation['base_price'] : ''; ?><?= isset($property['property_type_id']) && !in_array($property['property_type_id'], array(7,8,9,14)) ? '/per room' : ''; ?></td>
							    ...
							    <div class="col-md-3">
							        <div class="side-booking-footer light">
            							...
            							<div class="stbooking-footer-bottom">
            								<input type="submit" class="btn btn-block btn-theme" value="BOOK NOW">
