                        ...
                        <div class="attraction-item">
                            <div class="single-attraction-two radius-20">
                                <div class="single-attraction-two-thumb">
                                    <img src="<?= ($rowT['landscape_image'] != '') ? base_url('public/admin_images/landscape_images/' . $rowT['landscape_image']) : base_url('public/admin_images/property_images/no-image.jpg'); ?>" alt="<?php echo $rowT['terrain_name'];?>">
                                </div>
                                <div class="single-attraction-two-contents center-text">
                                    <h4 class="single-attraction-two-contents-title"> <?php echo $rowT['terrain_name'];?> </h4>
