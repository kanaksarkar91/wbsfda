...
<div class="main-banner" style="justify-content:end;">
    <!--  style="background-image:url(<?= base_url('public/frontend_assets/images/banner/room-booking/Room.jpg');?>);" data-overlay="7"> -->
<div class="container">
		<div data-ride="carousel" class="carousel carousel-fade" id="carousel-example-captions">
			...
			<div role="listbox" class="carousel-inner">
				<div class="carousel-item active">
					<img class="img-fluid" src="<?= base_url('public/frontend_assets/images/banner/room-booking/new-room1.jpg');?>" alt="...">
					
				</div>
				<div class="carousel-item">
					<img class="img-fluid" src="<?= base_url('public/frontend_assets/images/banner/room-booking/new-room2.jpg');?>" alt="...">
					
				</div>
				<div class="carousel-item">
					<img class="img-fluid" src="<?= base_url('public/frontend_assets/images/banner/room-booking/new-room3.jpg');?>" alt="...">
					
				</div>
				<!--<div class="carousel-item">
					<img class="img-fluid" src="<?= base_url('public/frontend_assets/images/banner/room-booking/room-4.jpg');?>" alt="...">
					<div class="carousel-caption">
					<h3>LET YOURSELF EXPERIENCE</h3>
					<h4>Our Rooms & Accomodations</h4>
					</div>
				</div>
				<div class="carousel-item">
