                        ...
                        <div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="booking_fname" id="booking_fname" class="form-control">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="booking_lname" id="booking_lname" class="form-control">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="booking_mobile" id="booking_mobile" class="form-control">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-12" id="org_name" style="display: none;">
								<div class="form-group">
									...
									<input type="text" name="booking_organisation_name" id="booking_organisation_name" class="form-control">
								</div>
							</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="table-responsive">
									<table class="table app-table-hover mb-0 text-left table-bordered">
										...
										?>
													<tr>
														<th class="cell"><?php echo date('d M Y', strtotime($dateToShow)).' To '.date('d M Y', strtotime($dateFrom));?></th>
														<th class="cell text-center"><?php echo number_format($policy->cancellation_per);?></th>
														<th class="cell text-right"><?php echo '₹&nbsp;'.number_format(floatval($refund_amount), 2, '.', ','); ?></th>
													</tr>
											<?php
													}
												} 
							 ...
							 <div class="col-lg-6 col-md-6 col-sm-12" style="margin-top:20px;">
								<div class="form-group">
									...
									<label for="checkbox" class="checkbox-custom-label">I accept the terms & conditions. <a style="text-decoration:underline; cursor:pointer; color:#8080FF;" data-toggle="modal" data-target="#termsModal" id="view_terms">View terms</a></label>
								</div>
							</div> 
							<div class="col-lg-12 col-md-12 col-sm-12">
			...
			<div class="col-lg-3 col-md-4">
				<div class="checkout-side">
					<div class="booking-short">
						...
						<b class="text-dark"><strong> Total Length of Stay:</strong>
...
function customerSection() {
	...
	var firstName = "<?= isset($customer_det->first_name) && $customer_det->first_name != '' ? $customer_det->first_name : ''; ?>";
	var lastName = "<?= isset($customer_det->last_name) && $customer_det->last_name != '' ? $customer_det->last_name : ''; ?>";
	var gender = "<?= isset($customer_det->gender) && $customer_det->gender != '' ? $customer_det->gender : ''; ?>";
	var age = "<?= isset($customer_det->age) && $customer_det->age != '' ? $customer_det->age : ''; ?>";
	var email = "<?= isset($customer_det->email) && $customer_det->email != '' ? $customer_det->email : ''; ?>";
	var mobile = "<?= isset($customer_det->mobile) && $customer_det->mobile != '' ? $customer_det->mobile : ''; ?>";
	
	if (guestType == "1") {
		$("#booking_fname").val(firstName);
		$("#booking_lname").val(lastName);
		$('#booking_gender [value='+ gender +']').attr('selected', 'true');
		$('#booking_age [value='+ age +']').attr('selected', 'true');
		...
		if ($(this).data('type') == 'apply') {
			...
			if (coupon_code != '') {
				$.ajax({
					...
					method: 'post',
					data: {coupon_code: coupon_code, propertyId: property_id},
					dataType: 'json',
				}).done(function(data) {
					if (data != null) {
						if (data.success) {
