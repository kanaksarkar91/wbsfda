...
<body>
	...
	<header class="header-style-01">
        <div class="header-top-bar d-flex align-items-center justify-content-center">
            <a class="mx-4" href="<?php echo base_url();?>"><img src="<?php echo base_url();?>public/frontend_assets/assets/img/SFDC_logo.png" width="64" alt="..." /></a>
            ...
            <a class="mx-4" href="<?php echo base_url();?>"><img src="<?php echo base_url();?>public/frontend_assets/assets/img/Biswa_Bangla_logo.png" width="48" alt="..." /></a>
        </div>
            ...
            <div class="container-xl custom-container-one nav-container">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="menu-item-has-children current-menu-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?php echo base_url();?>board-of-directors">Board of Directors</a></li>
                                <li><a href="<?php echo base_url();?>key-managerial-personnel">Key Managerial Personnel</a></li>
                                <li><a href="<?php echo base_url();?>history">History</a></li>
                                <li><a href="<?php echo base_url();?>our-objective">Our Objective</a></li>
                                <li><a href="<?php echo base_url();?>annual-reports">Annual Reports</a></li>
                                <li><a href="<?php echo base_url();?>activity-chart">Activity Chart</a></li>
                                <li><a href="<?php echo base_url();?>privacy-policy">Privacy Policy</a></li>
                                <li><a href="<?php echo base_url();?>terms-condition-guest-house-booking">Terms and Conditions of Guest House Booking</a></li>
                                <li><a href="<?php echo base_url();?>general-terms-condition">General Terms and Conditions</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children current-menu-item">
                            ...
                            <ul class="sub-menu">
                                <li><a href="<?php echo base_url();?>deposit-work-project">Deposit Work Projects</a></li>
                                <li><a href="<?php echo base_url();?>fishery-projects">Fishery Projects</a></li>
                                <li><a href="<?php echo base_url();?>learn-about-pisciculture">Learn About Pisciculture</a></li>
                                <li><a href="<?php echo base_url();?>fish-sale-wholesale-retail">Sale of Fish in Kolkata: Wholesale &amp; Retail</a></li>
                                <li><a href="<?php echo base_url();?>brief-reports-culture">Brief Reports on Culture</a></li>
                                <li><a href="<?php echo base_url();?>glimpse-major-work">A Glimpse of Major Work</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children current-menu-item">
                            ...
                            <ul class="sub-menu">
                                <li><a href="<?php echo base_url();?>">Guest House</a></li>
                                <li><a href="<?php echo base_url();?>">Conference / Banquet Hall</a></li>
                                <li><a href="<?php echo base_url();?>">Lawn / Picnic Spot</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children current-menu-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?php echo base_url();?>office-orders">Office Orders</a></li>
                                <li><a href="<?php echo base_url();?>organisation-chart">Organisation Chart</a></li>
                                <li><a href="<?php echo base_url();?>recruitments">Recruitments</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="<?php echo base_url();?>">PRESS RELEASE</a></li>

                        <li><a href="<?php echo base_url();?>">TENDERS</a></li>

                        <li class="menu-item-has-children current-menu-item">
                            <a href="javascript:void(0)">CONTACT</a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo base_url();?>">Head Office</a></li>
                                <li><a href="<?php echo base_url();?>">Guest House Contact</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
				...
				<div class="btn-group account-drop">
					...
					<div class="dropdown-menu pull-right animated flipInX">
						<a href="<?php echo base_url('my-booking')?>"><i class="ti-layers"></i> My Booking</a>
