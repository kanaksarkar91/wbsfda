                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;margin-bottom: 10px;">
                    <tr>
                        <td width="25%" style="text-align: center;padding:15px 0 0 15px;">
                            <img src="<?php echo base_url('public/frontend_assets/assets/img/bbl.png')?>" width="48" height="63" style="padding-right:10px;">
                        </td>
                        ...
                        <td width="25%" style="text-align: center;">
                            <img src="<?php echo base_url('public/frontend_assets/assets/img/sfdcl.png')?>" width="64" height="64" style="margin-top:10px; padding-left:10px;">
                        </td>                       
                    </tr>
                </table>
            </td>
