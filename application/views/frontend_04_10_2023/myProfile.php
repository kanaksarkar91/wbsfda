...
<!-- ============================ Page Title Start================================== -->
<div class="image-cover page-title" style="background:url(public/frontend_assets/assets/img/slider/06.jpg) no-repeat; background-size: cover; background-position: center;" data-overlay="6">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">

                <h2 class="ipt-title">My Profile</h2>
                <!-- <span class="ipn-subtitle text-light">My Profile Short tag line</span> -->
        ...
        <div class="row">
                ...
                <div class="dashboard-navbar dashboard-left-content">
                    ...
                    <div class="d-navigation"> 
                        <ul class="dashboard-list list-style-none">
                            <li class="list active"><a href="<?php echo base_url('my-profile') ?>"><i class="ti-user"></i> My Profile</a></li>
                            <li class="list"><a href="<?php echo base_url('my-booking')?>"><i class="ti-layers"></i> My Booking</a></li>
            ...
            <?php endif ?>
                    ...
                    <div class="form-submit">
                        <h4 class="fw-normal thm-txt mb-4">My Account</h4>
                            ...
                            <div class="submit-section">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="first_name" value="<?= $customer_details['first_name'].' '.$customer_details['last_name']; ?>">
                                    </div>

                                    <?php /*?><div class="form-group col-md-6">
                                        <label>Last Name</label>
                                        <input type="text" class="form-control" name="last_name" value="<?= $customer_details['last_name'] ?>">
                                    </div><?php */?>
                                    ...
                                    <div class="form-group col-md-6">
                                        <button type="submit" class="btn btn-theme">Update Changes</button>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#country_id').change(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("frontend/profile/getstate"); ?>',
                method: 'post',
                data: {
