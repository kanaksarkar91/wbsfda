                                            ...
                                            <div class="list-box-listing bookings">
                                                ...
                                                <div class="list-box-listing-content">
                                                    <div class="inner">
                                                        ...
                                                        <a class="btn btn-sm btn-view-detail view_details" href="javascript:void(0)" data-booking_id="<?php echo $vd['booking_id']?>" >View Details</a>
                                                        ...
                                                        <?php if(($vd['booking_status'] == '1') && ($vd['payment_method'] == 'Online')){ ?>
                                                            <button class="btn btn-sm btn-pay-now pay_now" data-booking_id = "<?php echo $vd['booking_id']?>" data-amount="<?php echo $vd['net_amount']?>">Pay Now</button>
                                                        <?php } ?>
