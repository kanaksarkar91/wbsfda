...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Add GST Slab </h1>
            </div>
            <div class="col-auto">
                    ...
                    <form class="settings-form">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-6">
                                ...
                                <input type="number" class="form-control" name="start_price" placeholder="Starting Price" min="0" required>
                            </div>
                            <div class="col-lg-4 col-sm-12 col-md-6">
                                <label for="end_price" class="form-label">Ending Price<span class="asterisk"> *</span></label>
                                <input type="number" class="form-control" name="end_price" placeholder="Ending Price" min="0" required>
                            </div>
                            <div class="col-lg-4 col-sm-12 col-md-6">
