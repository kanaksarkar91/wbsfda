...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Edit GST Slab </h1>
            </div>
            <div class="col-auto">
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <!--//col-->
                        <div class="col-auto">
                            <a class="btn app-btn-primary" href="<?= base_url('admin/gst_slab'); ?>">
                                VIEW ALL GST Slab 
                            </a>
                        </div>
                    </div>
        ...
        <div class="app-card app-card-settings shadow-sm p-3">
            ...
            <form class="settings-form" method="post" action="<?= base_url('admin/gst_slab/update_gst_slab'); ?>" enctype="multipart/form-data" autocomplete="off">
			<input type="hidden" name="<?= $this->csrf['name']; ?>" value="<?= $this->csrf['hash']; ?>">
            <input type="hidden" name="hotel_gst_slab_id" value="<?= $gst_slab['hotel_gst_slab_id'];?>">
                ...
                <div class="app-card-body">
                        <div class="row g-3">
                            <div class="col-lg-6 col-sm-12 col-md-6">
                                ...
                                <select name="hsn_sac_code" class="form-select" required>
									...
									if (isset($hsns))
										foreach($hsns as $hsn) {
									?>
									<option value="<?= $hsn['hsn_sac_id']; ?>" <?= $hsn['hsn_sac_id'] == $gst_slab['hsn_sac_code'] ? 'selected' : ''; ?>><?= $hsn['hsn_sac_code']; ?></option>
									<?php } ?>
								</select>
                            </div>
                            <div class="col-lg-6 col-sm-12 col-md-6">
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-6">
                                ...
                                <input type="number" class="form-control" name="start_price" placeholder="SGST Percentage" value="<?= $gst_slab['startg_price']; ?>" min="0" required>
                            </div>
                            <div class="col-lg-4 col-sm-12 col-md-6">
                                <label for="end_price" class="form-label">Ending Price<span class="asterisk"> *</span></label>
                                <input type="number" class="form-control" name="end_price" placeholder="Ending Price" value="<?= $gst_slab['ending_price']; ?>" min="0" required>
                            </div>
                            <div class="col-lg-4 col-sm-12 col-md-6">
