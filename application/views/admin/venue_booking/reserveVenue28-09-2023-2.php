        ...
        <div class="row g-4">
                                            ...
                                            <form action="#" class="custom-form" id="bookingForm" autocomplete="off"  method="post">
                                                ...
                                                <div class="details-contents-tab">
                                                    ...
                                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                        <li class="nav-item active" data-tab="individual" role="presentation">
                                                            <button class="nav-link active" id="pills-individual-tab" data-bs-toggle="pill" data-bs-target="#individual" type="button" role="tab" aria-controls="pills-individual" aria-selected="true">Individual</button>
                                                        </li>
                                                        <li class="nav-item" data-tab="organisation" role="presentation">
                                                            <button class="nav-link" id="pills-organisation-tab" data-bs-toggle="pill" data-bs-target="#organisation" type="button" role="tab" aria-controls="pills-organisation" aria-selected="false">Organisation</button>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content" id="pills-tabContent">
                                                        <div class="tab-pane fade show active" id="individual" role="tabpanel" aria-labelledby="pills-individual-tab">
                                                        ...
                                                        <div class="tab-pane fade" id="organisation" role="tabpanel" aria-labelledby="pills-organisation-tab">
                                                            <!-- <div id="organisation"> -->
                                                                <div class="input-flex-item">
                                                                    <div class="single-input mt-3">
                                                                        <label class="label-title"> Name<span class="asterisk text-danger"> *</span> </label>
                            ...
                            <div class="accordion-item shadow-sm">
                                ...
                                <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                                    <div class="accordion-body border-0 bg-white">
                                        ...
                                        <!-- <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseGSTchart" aria-expanded="false" aria-controls="collapseGSTchart">
                                            VIEW GST
                                        </button> -->
                                                ...
                                                <table class="table table-sm table-bordered align-middle">
                                                    <thead class="small">
                                                        <tr class="table-info">
                                                            ...
                                                            <th rowspan="2">(Rack) Rate</th>
                                                            <th rowspan="2">Date (Quantity)</th>
                                        ...
                                        <div class="mt-3">
                                            <p class="text-dark textForInputAdvPay"></p>
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-fill w-100"><button class="btn w-100 app-btn-primary rounded-0 pay_now" type="button">PAY NOW</button></div>
                                                </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-xl-4 col-lg-5">
                ...
                <?php if(isset($venues)){?>
                    ...
                    <div class="p-3 app-btn-primary"><h5 class="text-white">Booking Details</h5></div>
...
// When an accordion panel is shown, focus on its heading
 ...
 function isValidGSTListener(value) {
    ...
    if (customer_id > 0) {
        ...
        $("#indivisual_full_name").val(ind_name);
