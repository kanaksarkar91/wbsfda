                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    ...
                                    <div class="selected-reservation-date pb-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="btn-wrapper w-100 text-center mt-3">
                        ...
                        <div id="bookingSection" class="accordion-item shadow-sm">
                                <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                        <i class="las la-user-check me-3 fs-4"></i> Reservation to be done for
                                    </button>
                                </h2>
                                        ...
                                        <div class="mt-3">
                                            <p class="text-dark textForInputAdvPay"></p>
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-fill"><button class="btn w-100 btn-dark btn-lg pay_now" type="button">PAY NOW</button></div>
                                                </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response) {
                ...
                $('#gst_amount_booking').text('Rs. ' + gst_amount.toFixed(2));
                $('#net_amount_booking').text('Rs. ' + net_amount.toFixed(2));
