                        ...
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    ?>
                                    <a class="btn app-btn-primary" href="<?= base_url('admin/gst_slab_venue/add_gst_slab'); ?>">
                                        ADD NEW GST Slab 
                                    </a>
                                    <?php
                                        }
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell">
                                            ...
                                            ?>
                                            <a class="btn-sm app-btn-secondary" href="<?= base_url('admin/gst_slab_venue/edit_gst_slab/' . $slab['venue_gst_slab_id']) ?>">Edit</a>
                                            <?php
                                                }
                                            ?>
