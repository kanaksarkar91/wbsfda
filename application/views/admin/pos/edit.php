                ...
                <div class="app-card-body">
                        <div class="row g-3">
							...
							<div class="col-lg-4 col-sm-12 col-md-6">
								...
								<div>
									<input type="radio" name="is_it_pos" value="1" autocomplete="off" <?php if($pos['is_it_pos'] == 1){ echo 'checked'; } ?> >
									<label for="" class="form-label">Yes</label>
									

									<input type="radio" name="is_it_pos" value="2" autocomplete="off" <?php if($pos['is_it_pos'] == 2){ echo 'checked'; } ?>>
							...
							<div class="col-lg-4 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="cost_center_name" value="<?= $pos['cost_center_name'];?>" placeholder="POS Name" required>                              
                            </div>
							<div class="col-lg-4 col-sm-12 col-md-6">
                                <label for="" class="form-label">GSTIN<span class="asterisk"> *</span></label>
                                <input type="text" class="form-control" name="gstin" placeholder="GSTIN" value="<?= $pos['gstin'];?>" required>                              
                            </div>
							<div class="col-lg-4 col-sm-12 col-md-6">
                                <label for="" class="form-label">FSSAI<span class="asterisk"> </span></label>
                                <input type="text" class="form-control" name="fssai" value="<?= $pos['fssai'];?>" placeholder="FSSAI">                              
                            </div>
                            <?php /*?><div class="col-lg-6 col-sm-12 col-md-6">
                                <label for="" class="form-label">POS Code<span class="asterisk"> </span></label>
                                <input type="text" class="form-control" name="cost_center_code" value="<?= $pos['cost_center_code'];?>" placeholder="POS Code">                              
                            </div><?php */?>
                            <div class="col-lg-4 col-sm-12 col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <a class="btn app-btn-danger" href="<?=base_url('admin/pos')?>">CANCEL</a>
                            </div>
