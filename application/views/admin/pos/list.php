                            ...
                            <table class="table app-table-hover mb-0 text-left" id="cost_center_list_table">
                                ...
                                <?php 
                                    ...
                                    <tr>
										...
										<td class="cell"><?= ($row['is_it_pos'] == 1) ? 'Yes' : 'No';?></td>
                                        ...
                                        ?>
                                            <a class="btn-sm app-btn-primary" href="<?= base_url('admin/pos/editpos/' . encode_url($row['cost_center_id']));?>">Edit</a>
                                        </td>
                                        <?php
                                            }
                                        ?>
