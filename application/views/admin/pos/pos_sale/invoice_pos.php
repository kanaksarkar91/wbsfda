...
<body role="document"> -->
    <table id="printArea" cellpadding="0" cellspacing="0" border="0" style="width: 1000px; background: #FFF; margin: 0 auto; color:#000; font-family: Verdana, Geneva, Tahoma, sans-serif;font-size: 11px; padding: 0; text-align: center;">
        <tr>
            <td>
        ...
        <tr>
          <td>
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; text-align:left; margin-bottom: 6px;">
              <tr>
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Place of Supply</td>
                  ...
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;">Tax Invoice No.</td>
                  <td width="16%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;padding: 3px;" id="inv_no"></td>
              </tr>
              <tr>
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Address</td>
                  ...
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;">Date</td>
                  <td width="16%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;padding: 3px;" id="date"></td>
              </tr>
              <tr>
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">City / Village</td>
                  ...
                  <td width="8%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">District</td>
                  ...
                  <td width="8%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">PIN Code</td>
                  ...
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;">GSTIN</td>
                  <td width="16%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;padding: 3px;" id="property_gstin"></td>
              </tr>
              <tr>
                  <td width="10%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Point of Sales</td>
                  <td width="22%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;" id="unit_name"></td>
				  <td width="12%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Table / Room No.</td>
                  <td width="3%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;" id="table_no"></td>
                  <td width="8%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">fssai Lic No.</td>
                  ...
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;">State & Code</td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; text-align:left; margin-bottom: 6px;">
              <tr>
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Bill to</td>
                  <td width="58%" colspan="5" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;" id="pos_customer_name"></td>
                  <td width="13%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;">GSTIN</td>
                  <td width="16%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;padding: 3px;" id="pos_customer_gstin"></td>
              </tr>
            </table>

            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; text-align:left; margin-bottom: 6px;">
              <tr>
                  <td width="2%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Sl.</td>
				  <td width="24%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Item</td>
                  <td width="8%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Rate</td>
                  <td width="5%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Qty</td>
                  <td width="8%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Base Value</td>
                  <td width="5%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Discount</td>
                  <td width="8%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Price before GST</td>
                  <td width="8%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">HSN/SAC</td>
                  <td width="12%" colspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">CGST</td>
                  <td width="12%" colspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">SGST</td>
                  <td width="10%" rowspan="2" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Price after GST</td>
              </tr>
              <tr>
                  <td width="4%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">%</td>
                  <td width="8%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Amount</td>
                  <td width="4%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">%</td>
                  <td width="8%" style="font-size:11px;  padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Amount</td>
              </tr>
              ...
              <tr>
                ...
                <td style="font-size:11px; padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: right;"><b id="ti_"></b></td>
                ...
                <td style="font-size:11px; padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: right;"><b>&nbsp;</b></td>
                <td style="font-size:11px; padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: right;"><b id="cgst_">&nbsp;</b></td>
				...
				<td style="font-size:11px; padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: right;"><b id="sgst_">&nbsp;</b></td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                    <tr>
                        <td width="20%" style="text-align: center; padding: 3px;">
                        <span>Accepted</span><br><br><br><br><br>
                            <span>(Signature of the Guest)</span>
                        </td>
                        <td width="60%" style="text-align: center; padding: 3px;">
                         <br>Rate/Charges may increase when the items are supplied through room service, if available.<br>Materials once sold are not taken back.<br>This is a Computer Generated Invoice hence signature is not mandatory
                        </td>
                        <td width="20%" style="text-align: center; padding: 3px;">
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 1000px;margin: 0 auto; font-family: Verdana, Geneva, Tahoma, sans-serif;font-size: 11px; padding: 0;text-align: center; margin-top:20px;">
      <tr>
        ...
        <td width="20%">
		<a class="btn btn-success text-white" target="_blank" href="<?= base_url();?>admin/pos/pos_invoice_list/<?= encode_url($posHeader['property_id']);?>/<?= encode_url($posHeader['cost_center_id']);?>">Receivable</a>
		</td>
		<?php
		if($_GET['type'] == ''){
		?>
 ...
 function tax_invoice(){
    ...
    $.ajax({
		...
		.done(function(data) {
			...
			$('#property_state').text(data.pos_header.state_name + ' & ' + 19);
			...
			$('#pos_customer_name').text(data.pos_header.customer_name);
			$('#pos_customer_gstin').text(data.pos_header.customer_gstin);
			$('#table_no').text(data.pos_header.table_no);
       ...
       //var d = data.pos_header.order_generate_time; 
        //$('#date').text(d.getDate()+'/'+Number(d.getMonth() + 1)+'/'+d.getFullYear());
		$('#date').text(data.pos_header.order_generate_time);
		...
		$('#with_tax_total').text(parseFloat(Math.round(with_tax_total)).toFixed(2));
		...
		$('#total_inv_value_word').text(NumInWords(Math.round(with_tax_total)));
