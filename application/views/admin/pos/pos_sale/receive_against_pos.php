	...
	<?php endif ?>
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            ...
            <div class="col-auto">
				...
				<a class="btn app-btn-primary" href="<?= base_url();?>admin/pos/pos_invoice_list/<?= encode_url($inv_det['property_id']);?>/<?= encode_url($inv_det['cost_center_id']);?>">Receivable List</a>
					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
							<tr>
								...
								<?php
									$net_bill_amount = round($inv_det['net_bill_amount']);
									echo number_format($net_bill_amount,2);
								?>
								</td>
							</tr>
						</tbody>
                ...
                <div class="app-card-body">
                        <div class="row g-3">
                            <div class="col-lg-4 col-sm-12 col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="payment_date" name="payment_date" value="<?= date('Y-m-d');?>" readonly="">
                            </div>
							<div class="col-lg-4 col-sm-12 col-md-4 mb-3">
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="amount" name="amount" value="<?= number_format($net_bill_amount,2);?>" readonly="">
                            </div>
							<div class="col-lg-4 col-sm-12 col-md-4 mb-3">
                                <label for="" class="form-label">Customer Name<span class="asterisk"> </span></label>
                                <input type="text" class="form-control" id="customer_name" name="customer_name">
                            </div>
							<div class="col-lg-4 col-sm-12 col-md-4 mb-3">
                                <label for="" class="form-label">Customer Mobile<span class="asterisk"> </span></label>
                                <input type="text" class="form-control" id="mobile_no" name="mobile_no">
                            </div>
							<div class="col-lg-4 col-sm-12 col-md-4 mb-3">
                                <label for="" class="form-label">GSTIN<span class="asterisk"> </span></label>
                                <input type="text" class="form-control" id="customer_gstin" name="customer_gstin">
                            </div>
...
$(document).ready(function(){
	...
	$('#pos_invoice_form').validate({
		submitHandler:function(f){
			$.ajax({
				type:'POST',
				url: "<?= base_url('admin/pos/submit_pos_invoice'); ?>",
