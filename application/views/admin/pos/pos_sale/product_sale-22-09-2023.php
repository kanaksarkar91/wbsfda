			...
			<div class="col-auto">
				<div class="page-utilities">
					<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
						<!--//col-->
						<div class="col-auto">
							<a class="btn btn-success text-white" target="_blank" href="<?= base_url();?>admin/pos/pos_invoice_list/<?= encode_url($property_id);?>">Receivable</a>
						</div>
					</div>
					<!--//row-->
				</div>
...
function getCategories(){
	...
	$.ajax({
		...
		data 		: { csrf_test_name: '<?= $this->csrf['hash']; ?>', query:query, property_id: <?= $property_id;?> },
		dataType 	: 'json',
		encode 		: true
	})
	.done(function(data) {
