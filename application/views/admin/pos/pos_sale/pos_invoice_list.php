        <div class="app-content pt-3 p-md-3 p-lg-3">
            ...
            <?php endif ?>
                ...
                <div class="row g-3 mb-2 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">POS <?= $pos_invoice_list[0]['cost_center_name']?> Outstanding Receivable List</h1>
                    </div>
                    <div class="col-auto">
                            ...
                            <table class="table app-table-hover mb-0 text-left" id="pos_invoice_list">
								...
								?>
                                    <tr>
										...
										if($due_amount != 0){
										?>
                                            <a class="btn-sm app-btn-primary" href="<?= base_url('admin/pos/receive_against_pos/' . encode_url($row['sale_order_id']));?>">Receive</a>
											
											<?php /*?><button class="btn-sm btn-danger text-white cancel_pos_invoice" data-sale-order-id="<?= $row['sale_order_id'];?>">Cancel</button><?php */?>
										<?php
										}
										else{
										?>
