...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Add Tax </h1>
            </div>
            <div class="col-auto">
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <!--//col-->
                        <div class="col-auto">
                            <a class="btn app-btn-primary" href="<?= base_url('admin/tax'); ?>">
                                VIEW ALL Tax 
                            </a>
                        </div>
                    </div>
        ...
        <div class="app-card app-card-settings shadow-sm p-3">
            ...
            <form class="settings-form" method="post" action="<?= base_url('admin/tax/submit_tax'); ?>" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="app-card-body">
                        <div class="row g-3">
                            <div class="col-lg-6 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="tax_name" placeholder="Define Tax Name" required>
                                
                            </div>
                            <div class="col-lg-6 col-sm-12 col-md-6">
                                <label for="tax_percentage" class="form-label">Tax Percentage <span class="asterisk"> *</span></label>
                                <input type="text" class="form-control" name="tax_percentage" placeholder="Tax Percentage" required>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-6">
                                ...
                                <input type="date" class="form-control" name="eff_start_date" placeholder="Effective Start Date" required>
                            </div>
                            <div class="col-lg-4 col-sm-12 col-md-6">
