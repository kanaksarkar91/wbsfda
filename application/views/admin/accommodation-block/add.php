<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Add Accomodation Block</h1>
            </div>
            <div class="col-auto">
...
<script>
		...
		$('#accommodation-form').submit(function(e){
           ...
           var can_proceed = true;
            ...
            if(can_proceed){
                ...
                $.ajax({
                    type: 'POST',	
                    url: "<?= base_url('admin/AccommodationBlock/save'); ?>",
                    data: fd,
                    dataType: 'json',
                    encode: true,
                    async: false
    ...
    function getPropertyDetails(){
        ...
        $.ajax({
            type: 'POST',	
            url: "<?= base_url('admin/AccommodationBlock/getPropertyDetails'); ?>",
            data: {
                csrf_test_name: '<?= $this->csrf['hash']; ?>',
	...
	function validateAccommodationInput(accomo_value){
		...
		$.ajax({
            type: 'POST',	
            url: "<?= base_url('admin/AccommodationBlock/getRoomDetails'); ?>",
            data: {
                csrf_test_name: '<?= $this->csrf['hash']; ?>',
				'start_date':start_date,
                'end_date':end_date,
