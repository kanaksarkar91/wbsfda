...
<div class="app-content pt-3 p-md-3 p-lg-3">
  <div class="container-xl">
    ...
    <div class="row g-3 mb-4 align-items-center justify-content-between">
      <div class="col-auto">
        <h1 class="app-page-title mb-0">Edit District Master </h1>
      </div>
      <div class="col-auto">
    ...
    <div class="app-card app-card-settings shadow-sm p-4">
      ...
      <form class="settings-form" method="post" action="<?= base_url('admin/district/update_district'); ?>" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="app-card-body">
          <div class="row g-3">
            <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="district_name" value="<?= $district['district_name'] ?>" required>

            </div>
            <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
              <label for="tax_percentage" class="form-label">District Code <span class="asterisk"> *</span></label>
              <input type="text" class="form-control" name="district_code" value="<?= $district['district_code'] ?>" required>
            </div>
            ...
            <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
              ...
              <select class="form-select" name="state_id" required>
                ...
                <?php foreach ($states as $state) { ?>
                  <option value="<?= $state['state_id'] ?>" <?= ($state['state_id']==$district['state_id']) ? 'selected' : '' ?>><?= $state['state_name'] ?></option>
                <?php } ?>
              </select>
            </div>
            <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
              <label for="" class="form-label">Image<span class="asterisk"> *</span></label>
              <input type="file" class="form-control" name="district_image">
            </div>
            <div class="col-lg-2 col-sm-12 col-md-6 mb-3">
              <input type="hidden" class="form-control" name="district_image_old" value="<?= $district['district_image'] ?>">
              <img src="<?= base_url() . 'public/admin_images/district_images/' . $district['district_image'] ?>" width="50%" alt="Profile Picture" style="margin-top:21px">
            </div>
