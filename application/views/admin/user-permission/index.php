    ...
    <div class="container-xl">
        ...
        <div class="app-card app-card-orders-table shadow-sm mb-5">
            <div class="app-card-body">
                <div class="col-lg-4 col-sm-12 col-md-6 p-3" style="display: inline-flex">
...
<script>
    ...
    function saveMenuPermission(menu_id, menu_name){
        ...
        $.ajax({
            type: 'POST',	
            url: "<?= base_url('admin/UserPermission/ajaxUserPermissionHandler'); ?>",
            data: {
                user_role: user_role,
    ...
    function getRolePermission(role_id){
        $.ajax({
            type: 'GET',	
            url: "<?= base_url('admin/UserPermission/ajaxGetUserPermission'); ?>",
            data: {
                role_id: role_id,
				csrf_test_name: '<?= $this->csrf['hash']; ?>',
            },
