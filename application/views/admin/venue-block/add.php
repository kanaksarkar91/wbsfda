<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">ADD VENUE BLOCK</h1>
            </div>
            <div class="col-auto">
        ...
        <div class="app-card app-card-settings shadow-sm p-3">
            <div class="app-card-body">
                ...
                ?>
                <form class="settings-form" id="venue-form" method="post" action="<?= base_url('admin/VenueBlock/save') ?>" enctype="multipart/form-data" autocomplete="off">
                <input type="hidden" name="<?= $this->csrf['name']; ?>" value="<?= $this->csrf['hash']; ?>">    
                <div class="row g-3">
                        <div class="col-sm-12 col-md-3">
                            <label for="start_date" class="form-label">Start Date<span class="asterisk"> *</span></label>
                            <input type="text" class="form-control datePicker" id="start_date" name="start_date" value="" required onchange="getPropertyDetails()">
                        </div>
                        <div class="col-sm-12 col-md-3">
                            <label for="end_date" class="form-label">Till Date<span class="asterisk"> *</span></label>
                            <input type="text" class="form-control datePicker" id="end_date" name="end_date" value="" required onchange="getPropertyDetails()">
                        </div>
                        <div class="col-sm-12 col-md-3">
                            <label for="property_id" class="form-label">Property<span class="asterisk"> *</span></label>
                            <select name="property_id" class="form-select select2" id="property_id" required onchange="populate_venue(this.value)">
...
<script>
        ...
        $('#venue-form').submit(function(e){
           ...
           var can_proceed = true;
            ...
            if(can_proceed){
                ...
                $.ajax({
                    type: 'POST',	
                    url: "<?= base_url('admin/VenueBlock/save'); ?>",
                    data: fd,
                    dataType: 'json',
                    encode: true,
                    async: false
    ...
    /*function validateVenueInput(select){
