    ...
    <div class="app-content pt-3 p-md-3 p-lg-3">
        <div class="container-xl">
            <div class="row g-3 mb-2 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">POS Transaction Report</h1>
                </div>
                <div class="col-auto">
    ...
    $('#collection_list').DataTable( {
       ...
       "bPaginate": false,
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 6 ).footer() ).html(beforegstTotal.toFixed(2));
            $( api.column( 7 ).footer() ).html(gstTotal.toFixed(2));
            $( api.column( 8 ).footer() ).html(aftergstTotal.toFixed(2));
        },
        buttons: [{
            "extend": 'excel',
            "footer": true,
            ...
            'filename': 'POS_Transaction_Report'+ today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate()+'_'+today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds(),
            },
            {
            "extend": 'csv',
            "footer": true,
