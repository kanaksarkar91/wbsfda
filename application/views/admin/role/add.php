        ...
        <div class="app-content pt-3 p-md-3 p-lg-3">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-2 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Add Job Role</h1>
                    </div>
                    <div class="col-auto">
                ...
                <div class="app-card app-card-settings shadow-sm p-3">
                    ...
                    <div class="app-card-body">
                        <form class="settings-form" method="post" action="<?= base_url('admin/role/submitrole'); ?>" enctype="multipart/form-data" autocomplete="off">
