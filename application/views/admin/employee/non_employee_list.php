...
$('input[name="daterange"]').on('cancel.daterangepicker', function(ev, picker) {
    ...
    $("#download_excel").on('click',function(){
        ...
        window.location.href = '<?= base_url()?>' +'admin/employee/download_non_employee_list?fieldunit_id='+fieldunit_id+'&location_id='+location_id+'&sports_facilities_id='+sports_facilities_id+'&daterange='+daterange;
    })
