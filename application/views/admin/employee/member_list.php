<div class="app-content pt-3 p-md-3 p-lg-3">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form id="update_employee_status_form" method="post" action="<?= base_url('admin/Employee/update_member_status'); ?>" autocomplete="off">
...
$('input[name="daterange"]').on('cancel.daterangepicker', function(ev, picker) {
    ...
    $("#download_excel").on('click',function(){
        ...
        window.location.href = '<?= base_url()?>' +'admin/employee/download_member_list?fieldunit_id='+fieldunit_id+'&location_id='+location_id+'&sports_facilities_id='+sports_facilities_id+'&daterange='+daterange;
    })
