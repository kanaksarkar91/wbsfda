            ...
            <?php endif ?>
                ...
                <div class="app-card app-card-orders-table shadow-sm mb-5">
                    ...
                    <form method="post" class="p-2 table-search-form row gx-1 align-items-center" action="<?=base_url('admin/employee/payment_list')?>" autocomplete="off">
                        ...
                        <form id="update_payment_form" method="post" action="<?= base_url('admin/Employee/update_payment_status'); ?>" autocomplete="off">
...
$('input[name="daterange"]').on('cancel.daterangepicker', function(ev, picker) {
        ...
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    ...
                    // $.ajax({
                    //     url:'<?= base_url("admin/Employee/update_payment_status"); ?>',
                    //     method: 'post',
    ...
    $("#download_excel").on('click',function(){
        ...
        window.location.href = '<?= base_url()?>' +'admin/employee/download_payment_list?fieldunit_id='+fieldunit_id+'&location_id='+location_id+'&sports_facilities_id='+sports_facilities_id+'&daterange='+daterange;
    })
