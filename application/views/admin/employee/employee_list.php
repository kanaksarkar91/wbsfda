        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form id="update_employee_status_form" method="post" action="<?= base_url('admin/Employee/update_employee_status'); ?>" autocomplete="off">
...
<script>
        ...
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    ...
                    // $.ajax({
                    //     url:'<?= base_url("admin/Employee/update_employee_status"); ?>',
                    //     method: 'post',
    ...
    $("#download_excel").on('click',function(){
        ...
        window.location.href = '<?= base_url()?>' +'admin/employee/download_employee_list?fieldunit_id='+fieldunit_id+'&location_id='+location_id+'&sports_facilities_id='+sports_facilities_id+'&daterange='+daterange;
    })
