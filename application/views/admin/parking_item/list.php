                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                ?>
                                    <a class="btn app-btn-primary" href="<?= base_url('admin/parking_item/additem') ?>">
                                        ADD Item 
                                    </a>
                                <?php
                                    }
                ...
                <div class="app-card app-card-orders-table shadow-sm mb-5">
                    <div class="app-card-body">
                        <div class="table-responsive">
                            <table class="table app-table-hover mb-0 text-left" id="item_list_table">
                                <thead>
                                    <tr>
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        <td class="cell"><?=++$i;?></td>
                                        <td class="cell"><?=$row['item_name']?></td>
                                        <td class="cell"><?=$row['property_name']?></td>
                                        <td class="cell text-right"><?=$row['price']?></td>
                                        ...
                                        ?>
                                            <a class="btn-sm app-btn-primary" href="<?= base_url('admin/parking_item/edititem/' . encode_url($row['item_id']));?>">Edit</a>
                                        </td>
                                        <?php
                                            }
                                        ?>
