...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl" id="container-xl">
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Add Rate </h1>
            </div>
            <div class="col-auto">
...
<script type='text/javascript'>
    ...
    $(document).ready(function(){
		...
		$('#add-rate-form').submit(function(e){
			...
			if($(this).find('input[name="end_date"]').val() != ''){
				var startDate = convertDateFormat($(this).find('input[name="start_date"]').val());
				var endDate = convertDateFormat($(this).find('input[name="end_date"]').val());
				console.log(endDate);
				
				if(startDate > endDate){
					$('#btn-form-submit').before('<p class="result-msg text-danger">Effective Start Date is greater than Effective End Date!!</p>');
	...
	function convertDateFormat(dateStr) {
		// Split the date string into an array [dd, mm, yyyy]
		var parts = dateStr.split("-");
		
		// Rearrange and join the array into yyyy-mm-dd format
