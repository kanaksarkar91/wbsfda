                ...
                <div class="app-card-body mb-3">
                    <div class="row g-3">
                        ...
                        <?php /*?><div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                            <label for="extra_bed" class="form-label">Extra Bed (Rate in Rs.)<span class="asterisk"> </span></label>
                            <input type="number" min="0" step=".01" class="form-control" name="extra_bed" id="extra_bed" onkeyup="apply_extra_bed(this.value);" placeholder="Extra Bed" value="0">
                        </div><?php */?>
                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                ...
                                <table class="table table-striped table-hover mb-0 text-left" id="">
                                    <thead>
                                        <tr>
                                            ...
                                            <!--<th class="text-center">Extra Bed (Rate in Rs.)</th>-->
