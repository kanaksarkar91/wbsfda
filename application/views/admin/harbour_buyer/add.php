...
<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container">
			<div class="row g-3 mb-3 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Add Buyer</h1>
				</div>
				<div class="col-auto">
					...
					<div class="app-card-body">
						<div class="row g-3">							
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<input type="text" name="buyer_name" class="form-control buyer_name" required>
							</div>
							<div class="col-sm-6 col-md-6 col-lg-6">
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<div>
									...
									<input type="radio" name="buyer_type" class="buyer_type" value="B" checked>

									<label for="" class="form-label">Licensee</label>
									<input type="radio" name="buyer_type" class="buyer_type" value="L">
								</div>
							</div>
						</div>
					</div>
