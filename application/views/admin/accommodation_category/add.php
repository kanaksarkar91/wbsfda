...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <form class="settings-form" method="post" action="<?= base_url('admin/sports_facilities/submitsports_facilities'); ?>" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <form class="settings-form">
                        <div class="row g-3">
                            <div class="col-sm-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="" placeholder="Accommodation Category Name" required>
                            ...
                            <div class="col-lg-3 col-sm-12 col-md-6 mb-3">
                                ...
                                <select name="" class="form-select" id="" required>
                                    ...
                                    <option value="" selected disabled>AC</option>
                                    <option value="" selected disabled>None AC</option>
                                    <option value="" selected disabled>Tent</option>
                                </select>
                            </div>
                            <div class="col-lg-3 col-sm-12 col-md-6 mb-3">
                            ...
                            <div class="col-lg-3 col-sm-12 col-md-6 mb-3">
                                <label for="" class="form-label">Allowed Pax<span class="asterisk"> *</span></label>
                                <input type="text" class="form-control" name="" placeholder="Allowed Pax" required>
                            </div>
                            <div class="col-lg-3 col-sm-12 col-md-6 mb-3">
                                <label for="" class="form-label">Status<span class="asterisk"> *</span></label>
                                <select name="" class="form-select" id="" required>
                                    <option value="" selected disabled>Active</option>
                                    <option value="" selected disabled>Inactive</option>
                                </select>
                            </div>
