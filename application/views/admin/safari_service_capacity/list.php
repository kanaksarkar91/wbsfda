        <div class="app-content pt-3 p-md-3 p-lg-3">
            ...
            <?php endif ?>
                ...
                <div class="row g-3 mb-2 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Safari Services Capacity</h1>
                    </div>
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    ?>
                                    <a class="btn app-btn-primary" href="<?= base_url('admin/safari_service_capacity/add_service_capacity'); ?>">
                                        Add Safari Service Capacity
                                    </a>
                                    <?php
                                        }
                                    ?>
                    ...
                    <div class="app-card-body">
                        <div class="table-responsive">
                            <table class="table app-table-hover mb-0 text-left" id="property_listing_table">
                                ...
                                <?php
								$i = 1;
								if (isset($serviceCapacities))
									foreach($serviceCapacities as $row) {
								?>
                                    <tr>
                                        <td class="cell"><?= $i++; ?></td>
                                        ...
                                        ?>
                                            <a class="btn-sm app-btn-primary" href="<?= base_url('admin/safari_service_capacity/edit_service_capacity/' . encode_url($row['safari_service_header_id']).'/'.encode_url($row['service_period_master_id'])) ?>">View & Terminate</a>
                                        <?php
                                            }
                                        ?>
                                        </td>
