...
<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container">
			...
			<form action="<?= base_url(); ?>admin/budget/approval_submit" method="post" enctype="multipart/form-data" id="approvalForm">
				...
				<input type="hidden" name="budget_modify" value="1">
					...
					<div class="app-card-body pb-3">
									...
									<?php foreach($estimation_details['budget_details'] as $estimation){ ?>
										...
										<tr>
											...
											<td width="" class="cell">
													...
													<textarea name="approved_remarks[]" id="" cols="" rows="2" class="form-control estimation_remarks"><?= $estimation['approved_remarks']; ?></textarea>
						...
						<div class="row">
							...
							<div class="col-md-12 text-end px-4">
								<input type="submit" class="btn app-btn-primary approvalFormsubmit" name="" value="Update">
							</div>
						</div>
					</div>
				</div>
