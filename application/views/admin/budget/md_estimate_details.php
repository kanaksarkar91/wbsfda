				...
				<div class="app-card app-card-settings shadow-sm mb-3 pt-2">
					<div class="app-card-body px-2 pb-4">
						...
						<div class="row">
                            ...
                            <?php if($estimation_details['md_approval_status'] == '0'){ ?>
                                ...
                                <div class="col-md-1">
                                    ...
                                    <a href="javascript:void(0)" class="btn app-btn-primary budgetApprove" data-approvetype="1">Approve</a>
                                </div>
                                <div class="col-md-1">
                                    <!--<label for="" class="form-label w-100">&nbsp;</label>
                ...
                buttons: {
                    Ok: {
                        ...
                        action: function(){  							
                            ...
                            $.ajax({
                                type: "POST",
                                url: baseUrl+'admin/budget/md_approve_reject',
