...
<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container">
			...
			<form action="<?= base_url(); ?>admin/budget/submit_draftestimate" method="post" enctype="multipart/form-data" id="verifyForm">
				...
				<div class="app-card app-card-settings shadow-sm mb-3 pt-2">
					<div class="app-card-body pb-3">
						<h6 class="p-3"><span class="mainDate">Proposed Expenditure for the Month of: <?= $fYear; ?> submitted on <?= date("d-m-Y", strtotime($estimation_details['estimated_ts'])); ?></span></h6>
						<div class="table-responsive">
							<table class="table align-middle table-hover table-sm" style="border:1px solid #e7e9ed;">
								...
								<tbody>
									...
									<?php foreach($estimation_details['budget_details'] as $estimation){ ?>
										...
										<tr>
											...
											<td width="" class="cell text-end">
													<input type="text" class="form-control text-end fw-bold estimated_expence_amount" name="estimated_expence_amount[]" value="<?= $estimation['estimated_expence_amount']; ?>" placeholder="0.00">
											...
											<td width="" class="cell">
													...
													<textarea name="estimation_remarks[]" id="" cols="" rows="2" class="form-control estimation_remarks"><?= $estimation['estimated_remarks']; ?></textarea>
											...
											<td width="" class="cell text-end">
													<input type="text" class="form-control text-end fw-bold approved_expence_amount" name="approved_expence_amount[]" value="<?= $estimation['approved_expence_amount']; ?>" placeholder="0.00">
													<!--<input type="hidden" name="budget_details_id[]" value="<?php //echo $estimation['budget_details_id']; ?>">-->
											...
											<td width="" class="cell">
													...
													<textarea name="approved_remarks[]" id="" cols="" rows="2" class="form-control approved_remarks"><?= $estimation['approved_remarks']; ?></textarea>
									...
									<tr style="background-color: #1a4919; font-size: 1.1rem;">
                                        ...
                                        <input type="hidden" name="total_estimated_amount" class="total_estimated_amount" value="<?= $estimation_details['estimated_expence_total']; ?>">
						...
						<div class="row">
							...
							<div class="col-md-12 text-end px-4">
								<input type="submit" class="btn app-btn-primary verifyFormsubmit" name="" value="Submit to Head Office">
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	$( document ).ready(function() {
		...
		$(document).on('click', '.verifyFormsubmit', function(e) {
