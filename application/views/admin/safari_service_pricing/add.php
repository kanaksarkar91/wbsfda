...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Add Safari Service Pricing </h1>
            </div>
            <div class="col-auto">
        ...
        <div class="app-card app-card-settings shadow-sm p-3">
            ...
            <form class="settings-form" method="post" action="<?= base_url('admin/safari_service_pricing/submit_service_pricing'); ?>" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="app-card-body">
                        <div class="row g-3">
							...
							<div class="col-lg-4 col-sm-12 col-md-6">
								...
								<input type="text" class="form-control" name="start_date" id="start_date" placeholder="Effective Start Date" readonly="" required>
							</div>
							<div class="col-lg-4 col-sm-12 col-md-6">
								<label for="end_date" class="form-label">Effective End Date<span class="asterisk"> </span></label>
								<input type="text" class="form-control" name="end_date" id="end_date" placeholder="Effective End Date" readonly="">
							</div>
                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12">
                                ...
                                <a class="btn app-btn-danger" href="<?= base_url('admin/safari_service_pricing'); ?>">CANCEL</a>
                            </div>
                        </div>
                </div>
            </form>
...
$(document).ready(function(){
	...
	$(function() {
		...
		$("#start_date").datepicker({
			...
			onSelect: function(selectedDate) {
				...
				$("#end_date").datepicker("option", "minDate", minDate); // Set minimum date for check-out
			}
		});
		...
		$("#end_date").datepicker({
			...
			onSelect: function(selectedDate) {
				...
				$("#start_date").datepicker("option", "maxDate", maxDate); // Set maximum date for check-in
			}
		});
	});
	...
	$("#service_period_master_id").change(function(){ 
		...
		$.ajax({
			type: 'POST',	
			url: '<?= base_url("admin/safari_service_pricing/getSlotsWithCat"); ?>',
			data: {
