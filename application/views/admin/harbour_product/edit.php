...
<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container">
			...
			<form method="POST" action="" id="dailyIncomeform">
                ...
                <input type="hidden" name="product_id" value="<?= $product_details['harbour_product_id']; ?>">
					...
					<div class="app-card-body">
						<div class="row g-3">							
							<div class="col-sm-6 col-md-4 col-lg-4">
								...
								<input type="text" name="product_name" class="form-control product_name" value="<?= $product_details['harbour_product_name']; ?>" required>
							</div>
							<div class="col-sm-6 col-md-4 col-lg-4">
								...
								<select name="uom_id" class="form-control select2 uom_id" id="uom_id" required>									
									<?php if(!empty($uom_list)){ ?>
										...
										<?php foreach($uom_list as $uom){ ?>
											<option value="<?= $uom['uom_id']; ?>" <?php if($product_details['uom_id'] == $uom['uom_id']){ echo 'selected'; } ?>><?= $uom['uom_name']; ?></option>
										<?php } ?>
							...
							<div class="col-sm-6 col-md-4 col-lg-4">
								...
								<div>
									<input type="radio" name="product_type" class="product_type" value="P" <?php if($product_details['product_type'] == 'P'){ echo 'checked'; } ?>>
									<label for="" class="form-label">Harbour Products</label>
									
									<input type="radio" name="product_type" class="product_type" value="F" <?php if($product_details['product_type'] == 'F'){ echo 'checked'; } ?>>
