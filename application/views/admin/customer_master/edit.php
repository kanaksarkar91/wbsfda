      ...
      <div class="col-auto">
        <div class="page-utilities">
          <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
            <!--//col-->
            <div class="col-auto">
              <a class="btn app-btn-primary" href="<?=base_url('admin/customer')?>">
                VIEW ALL Customer
              </a>
            </div>
          </div>
      ...
      <form class="settings-form" method="post" action="<?= base_url('admin/customer/updatecustomer'); ?>" enctype="multipart/form-data" autocomplete="off">
          ...
          <div class="app-card-body">
            <div class="row g-3">
              ...
              <div class="col-lg-3 col-sm-12 col-md-6">
                <label for="" class="form-label">Customer Full Name <span class="asterisk"> *</span></label>
                <input type="text" class="form-control" name="first_name" value="<?= $customer['first_name'] ?>" required="">
              </div>
              <?php /*?><div class="col-lg-3 col-sm-12 col-md-6">
              ...
              <div class="col-12">
                ...
                <a class="btn app-btn-danger" href="<?=base_url('admin/customer')?>">CANCEL</a>
              </div>
          </div>
        </div>
      </form>
