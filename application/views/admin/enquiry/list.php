                            ...
                            <table class="table app-table-hover mb-0 text-left" id="fieldunit">
                                ...
                                <?php 
                                    ...
                                    <tr>
										...
										<td class="cell">
										<button type="button" class="btn btn-info" style="color:white;" id="reply_button" data-enquiry_id="<?= $enquiry['enquiry_id'];?>" data-customer_name="<?= $enquiry['customer_name'];?>" data-customer_email="<?= $enquiry['customer_email'];?>" data-mail_subject="<?= $enquiry['mail_subject'];?>">Reply</button>
										</td>
                                    </tr>
                                    <?php } 
                                    }else{ ?>
