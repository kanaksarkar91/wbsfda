                    ...
                    <form class="settings-form">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="approx_capacity" placeholder="Enter Approx Capacity" value="<?= $venue['approx_capacity']; ?>">                              
                            </div> 
                            <div class="col-lg-6 col-sm-12 col-md-6">
                                <label for="" class="form-label">Available Timming</label>
                                <input type="text" class="form-control" name="available_timming" placeholder="Enter Available Timming" value="<?= $venue['available_timming']; ?>">                              
                            </div> 
                            ...
                            <?php if(!empty($venue['venue_image'])){ ?>
                                ...
                                <?php foreach($venue['venue_image'] as $vimage){ ?>

                                    <div class="col-lg-2 col-sm-12 col-md-6">
                                        <span style="position: relative; left: 162px; bottom: 48px;"><a href="<?= base_url('admin/venue/deletevenue/' . $vimage['venue_image_id'].'/'.$venue['venue_id']) ?>" class="checkDelete" title="Delete Image"><i class="fa fa-times-circle" style="color: red; background: #fff; border-color: #be0723; border-radius: 50%;"></i></a></span>
                                        <img src="<?= base_url('public/admin_images/' . $vimage['image_path']); ?>" id="image1" alt="" height="100" width="150">
                                    </div>
                            ...
                            <div class="col-lg-3 col-sm-12 col-md-6">
                                <label for="" class="form-label">Image<span class="asterisk"> </span></label>
                                <img src="<?= !is_null($venue['image2']) ? base_url('public/admin_images/' . $venue['image2']) : base_url().'/public/admin_assets/images/property_default_image.png'; ?>" id="image2" alt="" height="50" width="75">
                            ...
                            <div class="col-lg-3 col-sm-12 col-md-6">
                                <label for="" class="form-label">Image<span class="asterisk"> </span></label>
                                <img src="<?= !is_null($venue['image3']) ? base_url('public/admin_images/' . $venue['image3']) : base_url().'/public/admin_assets/images/property_default_image.png'; ?>" id="image3" alt="" height="50" width="75">
                            ...
                            <div class="col-lg-3 col-sm-12 col-md-6">
                                <label for="" class="form-label">Image<span class="asterisk"> </span></label>
                                <img src="<?= !is_null($venue['image4']) ? base_url('public/admin_images/' . $venue['image4']) : base_url().'/public/admin_assets/images/property_default_image.png'; ?>" id="image4" alt="" height="50" width="75">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.checkDelete', function(e) {
...
$("#is_active").change(function() {
    ...
    if (selectedValue === "0") { // If switching to Inactive
        $.ajax({
            type: 'POST',
            url: "<?= base_url('admin/venue/checkVenueMapping'); ?>",
            data: {
                venue_id: venueId,
        ...
        .done(function(data) {
            if (data.is_mapped) {
                ...
                $('#modal_msg').html('Venue is already mapped as a multiple venue option');
