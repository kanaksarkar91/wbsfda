                                    ...
                                    <div class="col-sm-12 col-md-4 mb-3" style="<?=(in_array($reservation[0]['booking_status'],array('0','3')) && $reservation[0]['is_event_started'] == 0)?'display:block;':'display:none;'?>">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline" style="float:left; <?=($reservation[0]['booking_status'] == '0')?'display:block;':'display:none;'?>">
                                                <input class="form-check-input" type="radio" name="status" id="status_1" value="1"  <?=($reservation[0]['booking_status'] == '0')? 'required' : '' ?> <?= ($reservation[0]['booking_status'] == '1')?'checked':'' ?>>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm table-bordered app-table-hover mb-0 small">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge request-waiting">Request In Waiting</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Approval is valid till:</b> 09-09-2023 14:47</p>
                                                                <p class="mb-1"><b class="me-3">Approval Letter:</b> <a href="#." target="_blank">xxxxx_filenameXXX123.pdf <i class="fa fa-download"></i></a>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge request-approved">Request Approved</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Reject Reason:</b> lorem set dummy text lorem set dummy text</p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge request-reject">Request Rejected</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">NOC Letter:</b> <a href="#." target="_blank">xxxxx_filenameXXX123.pdf <i class="fa fa-download"></i></a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge status-confirmed">Confirmed</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Approved by:</b> Name</p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge status-cancelled">Cancelled</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Reject Reason:</b> lorem set dummy text lorem set dummy text</p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge approval-expired">Approval Expired</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Approval is valid till:</b> 09-09-2023 14:47</p>
                                                                <p class="mb-1"><b class="me-3">Approval Letter:</b> <a href="#." target="_blank">xxxxx_filenameXXX123.pdf <i class="fa fa-download"></i></a>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge paid-not-confirm">Paid But Not Confirmed</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Approval is valid till:</b> 09-09-2023 14:47</p>
                                                                <p class="mb-1"><b class="me-3">Approval Letter:</b> <a href="#." target="_blank">xxxxx_filenameXXX123.pdf <i class="fa fa-download"></i></a>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge request-expire">Request Expired</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Approval is valid till:</b> 09-09-2023 14:47</p>
                                                                <p class="mb-1"><b class="me-3">Approval Letter:</b> <a href="#." target="_blank">xxxxx_filenameXXX123.pdf <i class="fa fa-download"></i></a>
                                                        ...
                                                        <tr>
                                                            <td class="cell">09-09-2023 14:47</td>
                                                            <td class="cell"><span class="badge approval-revoke">Approval Revoked</span></td>
                                                            <td class="cell">Admin</td>
                                                            <td class="cell">
                                                                <p class="mb-1"><b class="me-3">Approval is valid till:</b> 09-09-2023 14:47</p>
                                                                <p class="mb-1"><b class="me-3">Approval Letter:</b> <a href="#." target="_blank">xxxxx_filenameXXX123.pdf <i class="fa fa-download"></i></a>
