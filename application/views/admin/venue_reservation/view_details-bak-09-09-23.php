...
<div class="app-content pt-3 p-md-3 p-lg-3">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Venue Reservation View Details</h1>
                    </div>
                    <div class="col-auto">
                ...
                <!--//row-->
                        ...
                        <div class="app-card app-card-settings shadow-sm p-3">
                            <div class="app-card-body">
                                ...
                                <div class="col-sm-12 col-md-8 mb-3">
                                    <label for="" class="form-label">Mailing Address with PIN Code </label>
                                    <textarea class="form-control" name="" id="" cols="" rows="8" readonly><?=$reservation[0]['agency_full_address']?></textarea>
                                </div>
                                <div class="col-sm-12 col-md-4 mb-3">
                               ...
                               <!-- <?php if($reservation[0]['payment_method'] == 'Offline' && $reservation[0]['booking_status'] == '3') { ?>
                                ...
                                <div class="col-sm-12 col-md-12 mb-3" style="<?=(in_array($reservation[0]['booking_status'],array('0','3')) && $reservation[0]['is_event_started'] == 0)?'display:block;':'display:none;'?>">
