            ...
            <div class="app-card-body">
                    ...
                    <div class="row g-3 add_room_div">
                        ...
                        <div class="col-lg-3 col-sm-12 col-md-6">
							...
							<input type="text" name="adult[]" value="<?= (isset($request_data))?(($request_data['is_select_extra_bed'] == 1) ? ($request_data['adults'] - 1) : $request_data['adults']):'';?>" class="form-control" readonly="">
                        </div>
                        <div class="col-lg-3 col-sm-12 col-md-6">
