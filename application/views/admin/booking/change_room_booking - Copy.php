...
.reserved:before {background: #ff2d00; width: 100%; height: 20px;content: '';position: absolute;left: 0;right: 0;}
        ...
        <div class="app-card app-card-settings shadow-sm p-3">
            ...
            <div class="app-card-body">
				...
				<input type="hidden" name="booking_id" value="<?= (isset($request_data))?$request_data['booking_id']:'';?>" readonly=""  />
				<input type="hidden" name="booking_detail_id" value="<?= $booking_detail_id;?>" readonly=""  />
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-sm-12 col-md-6">
							...
							<input type="hidden" name="property_id" id="property_id" value="<?= (isset($request_data))?$request_data['property_id']:'';?>"  />
                        </div>
                        <div class="col-lg-4 col-sm-12 col-md-6">
                            <label for="check_in_date" class="form-label">Check In <span class="asterisk"> *</span></label>
                            <input type="text" id="check_in_date" name="check_in_date" value="<?= (isset($detail_request_data))?date('Y-m-d', strtotime($detail_request_data['in_date'])):'';?>" class="form-control" readonly="">
                        </div>
                        <div class="col-lg-4 col-sm-12 col-md-6">
                            <label for="check_out_date" class="form-label">Check Out <span class="asterisk"> *</span></label>
							<input type="text" id="check_out_date" name="check_out_date" value="<?= (isset($detail_request_data))?date('Y-m-d', strtotime($detail_request_data['out_date'])):'';?>" class="form-control" readonly="">
                    ...
                    <div class="row g-3 add_room_div">
                        ...
                        <div class="col-lg-3 col-sm-12 col-md-6">
							...
							<input type="text" name="adult[]" value="<?= (isset($request_data))?$request_data['adults']:'';?>" class="form-control" readonly="">
                        </div>
                        <div class="col-lg-3 col-sm-12 col-md-6">
                            <label for="tax_name" class="form-label">Children </label>
							<input type="text" name="child[]" value="<?= (isset($request_data))?$request_data['children']:'';?>" class="form-control" readonly="">
                        </div>
                        <!-- <div class="col-md-2">
                                ...
                                <table class="table app-table-hover mb-0 text-left" id="sports_facilities">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="font-weight:bold;font-size: 19px;">Remarks </td>
                                            <td colspan="4">
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align:right; font-weight:bold;font-size: 19px;">Total : <span class=""><i class="fa fa-inr"></i></span> <span id="net_amount_txt"></span></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                            ...
                            <select class="form-select select2" disabled="disabled">
                                ...
                                <?php if (!empty($customer_list)) { ?>
                                    <?php foreach ($customer_list as $customer) { ?>
                                        <option value="<?= $customer['customer_id']; ?>" <?= (isset($request_data['customer_id']) && $request_data['customer_id'] == $customer['customer_id']) ? 'selected' : '' ?> data-customer_data='<?= json_encode($customer) ?>'><?= $customer['first_name'] . ' ' . $customer['last_name'] . ' - ' . $customer['mobile'] ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
							
							<input type="hidden" id="customer_id" name="customer_id" value="<?= $request_data['customer_id'];?>" required />
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Frist Name" value="<?= (isset($selected_customer_details))?$selected_customer_details['first_name']:'';?>" readonly="">
                                        ...
                                        <?php /*?><div class="col-lg-4 col-sm-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="<?= (isset($selected_customer_details))?$selected_customer_details['last_name']:'';?>" readonly="">
                                        </div><?php */?>

                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            <label for="cgst_percentage" class="form-label">Email Address <span class="asterisk"> *</span></label>
                                            <input type="email" class="form-control" id="email" name="email" placeholder="Email Address" value="<?= (isset($selected_customer_details))?$selected_customer_details['email']:'';?>" readonly="">
                                        </div>

                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            <label for="sgst_percentage" class="form-label">Mobile No. <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile No" value="<?= (isset($selected_customer_details))?$selected_customer_details['mobile']:'';?>" readonly="">
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="gst_number" name="gst_number" placeholder="GST Number" value="<?= (isset($selected_customer_details))?$selected_customer_details['gst_number']:'';?>" readonly="">

                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            <label for="tax_percentage" class="form-label">Company Name <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Company Name" value="<?= (isset($selected_customer_details))?$selected_customer_details['company_name']:'';?>" readonly="">
                                        </div>

                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            <label for="cgst_percentage" class="form-label">Business Email id </label>
                                            <input type="text" class="form-control" id="company_email" name="company_email" placeholder="Business Email id" value="<?= (isset($selected_customer_details))?$selected_customer_details['company_email']:'';?>" readonly="">
                                        </div>
                                        <div class="col-lg-12 col-sm-12 col-md-6">
                                            <label for="sgst_percentage" class="form-label">Company Address </label>
                                            <input type="text" class="form-control" id="company_address" name="company_address" placeholder="Company Address" value="<?= (isset($selected_customer_details))?$selected_customer_details['company_address']:'';?>" readonly="">
                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            <label for="sgst_percentage" class="form-label">Phone No. <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="company_phone" name="company_phone" placeholder="Phone No." value="<?= (isset($selected_customer_details))?$selected_customer_details['company_phone']:'';?>" readonly="">
                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-6">
...
<script type="text/javascript">
    ...
    $('#book_room_submit').click(function() {
        ...
        $.ajax({
            url: '<?= base_url("admin/booking/change_room_submit"); ?>',
            method: 'post',
            data: formData,
            dataType: 'json',
            processData: false,
