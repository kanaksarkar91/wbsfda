...
.reserved:before {background: #ff2d00; width: 100%; height: 20px;content: '';position: absolute;left: 0;right: 0;}
        ...
        <div class="app-card app-card-settings shadow-sm p-3">
            ...
            <div class="app-card-body">
				...
				<input type="hidden" name="booking_id" value="<?= (isset($request_data))?$request_data['booking_id']:'';?>"  />
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-sm-12 col-md-6">
                            ...
                            <input type="text" id="check_in_date" name="check_in_date" value="<?= (isset($request_data))?date('Y-m-d', strtotime($request_data['check_in'])):'';?>" class="form-control" readonly="">
                        </div>
                        <div class="col-lg-4 col-sm-12 col-md-6">
                            <label for="check_out_date" class="form-label">Check Out <span class="asterisk"> *</span></label>
							<input type="text" id="check_out_date" name="check_out_date" value="<?= (isset($request_data))?date('Y-m-d', strtotime($request_data['check_out'])):'';?>" class="form-control" readonly="">
                ...
                <div class="app-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
							...
							<input type="hidden" name="customer_id" id="customer_id" value="<?= $request_data['customer_id'];?>"  />
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Full Name" value="<?= (isset($selected_customer_details))?$selected_customer_details['first_name']:'';?>" readonly="">
...
<script type="text/javascript">
    ...
    $('#book_room_submit').click(function() {
        ...
        if (!$("#property_id").val()) {
            ...
            return false;
        } else if ($("#customer_id").val() == 0 && (!$("#first_name").val() || !$("#email").val() || !$("#mobile").val())) {
