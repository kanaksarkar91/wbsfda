<div class="app-content pt-3 p-md-3 p-lg-3">
	...
	<?php endif ?>
        ...
        <div class="row g-3 mb-2 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Check-In List</h1>
            </div>
            <div class="col-auto">
                            ...
                            <tr>
                                ...
                                <div class="btn-group dropend">
                                    ...
                                    <?php
									 ...
									 ?>
                                    <li style="background: #B2EBF2;"><a target="_blank" href="<?=base_url('admin/booking/downloadInvoice/'.$reservation->booking_id)?>" type="button" class="dropdown-item" title="Download">Download&nbsp;Tax&nbsp;Invoice</a></li>
									<?php
									}
