        ...
        <div class="app-card app-card-settings shadow-sm p-3">
                <div class="app-card-body">
                    <div class="row g-3">  
                        ...
                        <div class="col-md-12">
                            <div class="panel-heading"><div class="panel-title"><strong><?= $booking_details['property_name']; ?></strong><span style="float:right;"><img src="<?= base_url(); ?>public/admin_images/adult.png"> = 
							<?php
							$split_adult_child = explode('-', $booking_details['adult_children']); 
							echo $split_adult_child[0]; 
							?>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?= base_url(); ?>public/admin_images/children.png"> = <?= $split_adult_child[1]; ?></span></div></div>
                            <h5>Guest Details of Booking No.:  <?= $booking_details['booking_no']; ?></h5>
                            <hr>
                        </div>
                        <?php $i = 1; 
                        ...
                        <?php foreach ($booking_details['guest_details'] as $guest) { ?>                              
                            ...
                            <div class="row guest_main">
                                ...
                                <?php /*?><div class="col-md-3 text-right">
                                    <input type="radio" class="select_primary" name="select_primary[]" value="<?= $guest['guest_type']; ?>" <?php if($guest['guest_type'] == 'P'){ echo 'checked'; } ?> disabled><label for="select-guest_<?= $i; ?>" style="margin-left:10px;">Select for primary guest</label>
                                    <input type="hidden" class="select_primary_hidden" name="select_primary_hidden[]" value="<?= $guest['guest_type']; ?>">
                                </div><?php */?>

                                <div class="col-lg-4 col-sm-12 col-md-6">
                                    <label for="tax_name" class="form-label">Guest Name <span class="asterisk"> *</span></label>
                                    <input type="hidden" name="check_in_guest_id[]" value="<?= $guest['check_in_guest_id']; ?>">
									
									<input type="text" class="form-control" name="guest_name[]" placeholder="Guest Name" value="<?= $guest['name']; ?>" required>                                
                                </div>

                                <div class="col-lg-4 col-sm-12 col-md-6">
                                    <label for="tax_name" class="form-label"> Date of Birth <span class="asterisk"> <?php  if($i == 1) { ?>*<?php } ?> </span></label>
                                    <input type="date" class="form-control" name="guest_dob[]" placeholder="Guest Name" value="<?= $guest['dob']; ?>" <?php  if($i == 1) { ?> required <?php } ?>>                                
                                </div>
								<div class="col-lg-4 col-sm-12 col-md-6">
                                ...
                                <div class="col-lg-4 col-sm-12 col-md-6">
                                    ...
                                    <select class="form-select" name="guest_relation[]" <?php  if($i == 1) { ?> required <?php } ?>>
										...
										<option value="Friend" <?php if($guest['relation'] == 'Friend'){ echo 'selected'; } ?>>Friend</option>
										<option value="Colleague" <?php if($guest['relation'] == 'Colleague'){ echo 'selected'; } ?>>Colleague</option>
										<option value="Spouse" <?php if($guest['relation'] == 'Spouse'){ echo 'selected'; } ?>>Spouse</option>
                                ...
                                <div class="col-lg-4 col-sm-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="guest_id_number[]" placeholder="Identity No." value="<?= $guest['document_no']; ?>" required>                                
                                </div>
                                <div class="col-lg-4 col-sm-12 col-md-6">
                                ...
                                <div class="col-lg-4 col-sm-12 col-md-6 address_div" <?php if($guest['guest_type'] == 'N'){ echo 'style="display: none;"'; } ?>>
                                    <label for="tax_name" class="form-label">Address <span class="asterisk"> </span></label>
                                    <input type="text" class="form-control guest_address" name="guest_address[]" value="<?= $guest['address']; ?>" placeholder="Address">                                    
                                </div>
                                <div class="col-lg-4 col-sm-12 col-md-6 coming_div" <?php if($guest['guest_type'] == 'N'){ echo 'style="display: none;"'; } ?>>
                                    <label for="tax_name" class="form-label">Coming from <span class="asterisk"> </span></label>
                                    <input type="text" class="form-control guest_from" name="guest_from[]" value="<?= $guest['coming_from']; ?>" placeholder="Coming from">                                    
                                </div>
                                <div class="col-lg-4 col-sm-12 col-md-6 going_div" <?php if($guest['guest_type'] == 'N'){ echo 'style="display: none;"'; } ?>>
                                    <label for="tax_name" class="form-label">Going to <span class="asterisk"> </span></label>
                                    <input type="text" class="form-control guest_to" name="guest_to[]" placeholder="Going to" value="<?= $guest['going_to']; ?>">                                    
                                </div>
                                <div class="col-lg-4 col-sm-12 col-md-6 purpose_div" <?php if($guest['guest_type'] == 'N'){ echo 'style="display: none;"'; } ?>>
                                    <label for="tax_name" class="form-label">Purpose <span class="asterisk"> </span></label>
                                    <input type="text" class="form-control guest_purpose" name="guest_purpose[]" placeholder="Purpose" value="<?= $guest['purpose']; ?>">                                    
                                </div>
                                <div class="col-lg-4 col-sm-12 col-md-6 contact_div" <?php if($guest['guest_type'] == 'N'){ echo 'style="display: none;"'; } ?>>
                                    <label for="tax_name" class="form-label">Contact No. <span class="asterisk"> </span></label>
                                    <input type="text" class="form-control guest_contact" name="guest_contact[]" placeholder="Contact No." value="<?= $guest['phone']; ?>">                                    
                                </div>
								
                                <?php /*?><div class="col-lg-4 col-sm-12 col-md-6 aniver_div" <?php if($guest['guest_type'] == 'N'){ echo 'style="display: none;"'; } ?>>
                                    <label for="tax_name" class="form-label">Aniversary Date <span class="asterisk"> </span></label>
                                    <input type="Date" class="form-control guest_aniversary" name="guest_aniversary[]" placeholder="" value="<?= $guest['aniversary_date']; ?>">                                    
                                </div><?php */?>
						...
						?>
                            ...
                            <?php if($guest['doc_file']){ ?>
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-sm btn-primary" href="<?= base_url(); ?>public/guest_id/<?= $guest['doc_file']; ?>" target="_blank">View Document</a>
                                </div>
                            <?php } ?>
