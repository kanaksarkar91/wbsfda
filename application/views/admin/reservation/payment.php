            ...
            <div class="container-xl">
                ...
                <div class="app-card app-card-settings shadow-sm p-3">
                    ...
                    <div class="app-card-body">
                        <form class="settings-form" method="post" action="<?= base_url('admin/reservation/submitpayment'); ?>" enctype="multipart/form-data" autocomplete="off">
                        <input type="hidden" class="form-control" name="booking_id" value="<?= $reservation['booking_id'] ?>" readonly>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-12 col-md-12" style="<?=($reservation['status'] == '0')?'display:block;':'display:none;'?>">
