            ...
            <div class="container-xl">
                ...
                <div class="app-card app-card-settings shadow-sm p-3">
                    ...
                    <div class="app-card-body">
                        <form class="settings-form" method="post" action="<?= base_url('admin/reservation/submitreservation'); ?>" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <input type="hidden" class="form-control" id="organization_type" name="organization_type" value="<?= $reservation['organization_type'] ?>" readonly>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-12 col-md-12 Sports_Facility_table">
                                ...
                                <div class="col-sm-12 col-md-12" style="<?=(in_array($reservation['status'],array('0','3')) && $reservation['is_event_started'] == 0)?'display:block;':'display:none;'?>">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6 approve_div" style="<?= ($reservation['status'] == '1')?'display: block;':'display: none;' ?>">
                                    ...
                                    <?php if($reservation['approved_by'] != '' && $reservation['status'] == '1') { ?>
                                        ...
                                        <div class="col-sm-12 col-md-6 approve_div">
                                    ...
                                    <?php } ?>
                                        <div class="col-sm-12 col-md-12 reject_div" style="<?= ($reservation['status'] == '2')?'display: block;':'display: none;' ?>">
                                        ...
                                        <?php if($reservation['rejected_by'] != '' && $reservation['status'] == '2') { ?>
                                            <div class="col-sm-12 col-md-6 reject_div">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 cancellation_div" style="<?= !empty($reservation['cancellation_reason'])?'display: block;':'display: none;' ?>">
