...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Add New Tax </h1>
            </div>
            <div class="col-auto">
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <form class="settings-form" method="post" action="<?= base_url('admin/tax_venue/submit_tax'); ?>" enctype="multipart/form-data" autocomplete="off">
