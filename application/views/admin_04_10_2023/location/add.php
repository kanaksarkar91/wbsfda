<div class="app-content pt-3 p-md-3 p-lg-3">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Add New Location</h1>
                    </div>
                    <div class="col-auto">
                ...
                <div class="app-card app-card-settings shadow-sm p-4"> 
                    ...
                    <form class="settings-form" method="post" action="<?php echo base_url('admin/location/submitlocation'); ?>" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="app-card-body"> 
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="location_name" name="location_name" value="" required>
                                    </div>
                                </div>
                                <div class="row g-3">
