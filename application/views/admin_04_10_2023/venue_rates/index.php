                ...
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            ?>
                            <a class="btn app-btn-secondary" href="<?= base_url('admin/venue_rates/add') ?>">
                                Add New Rate
                            </a>
                            <?php
                                }
            ...
            <div class="app-card-body">
                ...
                ?>
                    <form class="settings-form" id="rate-form" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                        <div class="col-lg-3 col-sm-12 col-md-6 mb-3 mrg15R">
                        ...
                        <div class="col-lg-3 col-sm-12 col-md-6 mb-3 d-none">
                        ...
                        <div class="col-lg-3 col-sm-12 col-md-6 mb-3 sec-btn">
                            <label for="" class="form-label">&nbsp;</label>
                            <button type="submit" id="btn-form-submit" class="btn btn-primary"> <i class="fa fa-search" aria-hidden="true"></i> Search</button>
                            <a href="<?= base_url('admin/venue_rates') ?>" class="btn btn-primary">Reset</a>
                        </div>
                    </form>
                    <div class="col-md-12">
...
<script type='text/javascript'>
  ...
  $(document).ready(function(){
        ...
        $('#rate-form').submit(function(e){
            ...
            $.ajax({
                url:'<?= base_url("admin/venue_rates/getFilterData") ?>',
                method: 'GET',
                data: $(this).serialize(),
                dataType: 'json',
                encode: true,
                    ...
                    if(response.success){
                        ...
                        if(response.data.length > 0){
                            ...
                            $.each(response.data, function(index, data){
                                let edit = has_edit_access ? '<a href="'+base_url+'admin/venue_rates/edit/'+data.rate_id+'">Edit</a>': '';
                                list +='<tr>\
