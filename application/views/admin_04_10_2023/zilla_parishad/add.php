...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Add Zilla Parishad & Others
                </h1>
            </div>
            <div class="col-auto">
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <form class="settings-form" method="post" action="<?= base_url('admin/zilla_parishad/submitzilla_parishad'); ?>" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="app-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-sm-12 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="unit_name" placeholder="Zilla Parishad Name" required="">
                        </div>
