            ...
            <?php endif ?>
                ...
                <div class="app-card app-card-orders-table shadow-sm mb-5 p-4">
                    <div class="app-card-body">
                        <form class="settings-form" method="post" action="<?php echo base_url('admin/trainingcenterrate/submittrainingcenterrate'); ?>" enctype="multipart/form-data" autocomplete="off">
                            <div class="row g-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            var fieldunit_id = $(this).val();
                ...
                $.ajax({
                    url:'<?php echo base_url("admin/Trainingcenterrate/getlocation"); ?>',
                    method: 'post',
            ...
            var slug = 'Training centre';
                ...
                $.ajax({
                    url:'<?php echo base_url("admin/Trainingcenterrate/getTrainingcenters"); ?>',
                    method: 'post',
        ...
        $('#sports_facilities_id').change(function(){
            ...
            $.ajax({
                url:'<?php echo base_url("admin/Trainingcenterrate/getpreviousrate"); ?>',
                method: 'post',
