                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                ?>
                                    <a class="btn app-btn-primary" href="<?= base_url('admin/pos/addcategory') ?>">
                                        ADD Category
                                    </a>
                                <?php
                                    }
                            ...
                            <table class="table app-table-hover mb-0 text-left" id="category_list_table">
                                ...
                                <?php 
                                    ...
                                    <tr>
										...
										<td class="cell"><?=($row['category_flag'] == 'P') ? 'Product' : 'Service';?></td>
                                        ...
                                        ?>
                                            <a class="btn-sm app-btn-secondary" href="<?= base_url('admin/pos/editcategory/' . encode_url($row['category_id']));?>">Edit</a>
                                        </td>
                                        <?php
                                            }
                                        ?>
