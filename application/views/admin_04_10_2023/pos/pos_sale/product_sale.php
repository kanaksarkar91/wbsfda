				...
				<div class="page-utilities">
					<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
						...
						<button id="" class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCreatedFolder" aria-expanded="false" aria-controls="collapseCreatedFolder">Show Created Folder</button>
							<a class="btn btn-success text-white" target="_blank" href="<?php echo base_url();?>admin/pos/pos_invoice_list/<?php echo encode_url($property_id);?>/<?php echo encode_url($cost_center_id);?>">Receivable</a>
						</div>
					</div>
					<!--//row-->
				</div>
...
function getCategories(){
	...
	$.ajax({
		...
		data 		: { csrf_test_name: '<?php echo $this->csrf['hash']; ?>', query:query, property_id: <?php echo $property_id;?>, cost_center_id: <?php echo $cost_center_id;?> },
		dataType 	: 'json',
		encode 		: true
	})
	.done(function(data) {
