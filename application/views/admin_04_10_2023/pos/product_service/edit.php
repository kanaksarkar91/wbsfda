                ...
                <div class="app-card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-4">
                                ...
                                <input type="text" class="form-control" name="product_service_name" value="<?php echo $product_service['product_service_name'];?>" placeholder="Product/Service Name" required>                              
                            </div>
							<div class="col-lg-4 col-sm-12 col-md-4">
...
function populatecategory(pors_flag,selected){
	...
	$.ajax({
		type: 'POST',	
		url: '<?php echo base_url("admin/pos/getCategoryFlagWise"); ?>',
		data: {csrf_test_name: '<?php echo $this->csrf['hash']; ?>', property_id: property_id, category_flag: pors_flag},
		dataType: 'json',
		encode: true
	})
	//ajax response
