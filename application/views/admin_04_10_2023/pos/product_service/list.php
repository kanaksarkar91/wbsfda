                            ...
                            <table class="table app-table-hover mb-0 text-left" id="category_list_table">
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            <a class="btn app-btn-secondary" href="<?= base_url('admin/pos/editproductservice/' . encode_url($row['product_service_id']));?>">Edit</a>
											
											<a class="btn app-btn-primary" href="<?= base_url('admin/pos/sale_rate/' . encode_url($row['product_service_id']));?>">&#x20B9;</a>
                                        </td>
                                        <?php
                                            }
                                        ?>
