<div class="app-content pt-3 p-md-3 p-lg-3">
            ...
            <?php endif ?>
                ...
                <div class="app-card app-card-orders-table shadow-sm mb-5 p-4">
                    <div class="app-card-body">
                        <form class="settings-form" method="post" action="<?php echo base_url('admin/gymnasiumrate/submitgymnasiumrate'); ?>" enctype="multipart/form-data" autocomplete="off">
                            <div class="row g-3">
    ...
    <script>
        ...
        $('#sports_facilities_id').change(function(){
            ...
            $.ajax({
                url:'<?php echo base_url("admin/Gymnasiumrate/getpreviousrate"); ?>',
                method: 'post',
