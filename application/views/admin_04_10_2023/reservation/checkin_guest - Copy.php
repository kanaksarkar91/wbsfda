                    ...
                    <div class="row g-3">
                        ...
                        <?php //foreach($booking_details as $b_details){ ?>  
                            ...
                            <?php /*?><div class="col-md-12">
                                <div class="panel-heading"><div class="panel-title"><?php echo $b_details['accommodation_name']; ?><span style="float:right;"><img src="<?php echo base_url(); ?>public/admin_images/adult.png"> = <?php echo $b_details['adults']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url(); ?>public/admin_images/children.png"> = <?php echo $b_details['children']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url(); ?>public/admin_images/infant.png"> = <?php echo $b_details['infants']; ?></span></div></div>
                                <h6>Guest Details of room <?php echo $b_details['room_no']; ?></h6>
                                <hr>
                            </div><?php */?>
                            <?php //$b_details['total_guest'] ?>
                            <?php for ($x = 1; $x <= $guests; $x++) { ?>  
                                
                                <input type="hidden" name="checkin_details_id[]" value="<?php echo $b_details['check_in_detail_id']; ?>">
                                <input type="hidden" name="checkin_date[]" value="<?php echo $booking_details[0]['in_date']; ?>">
                                <input type="hidden" name="checkout_date[]" value="<?php echo $booking_details[0]['out_date']; ?>">
                                ...
                                <div class="row guest_main">
                                    ...
                                    <?php /*?><div class="col-md-3 text-right">
                                        <input type="radio" class="select_primary" name="select_primary[]" value="<?php if($x == 1){ echo 'P'; } else { echo 'N'; } ?>" <?php if($b_details['total_guest'] == 1){ echo 'checked'; } ?>><label for="select-guest_<?php echo $x; ?>" style="margin-left:10px;">Select for primary guest</label>
                                        <input type="hidden" class="select_primary_hidden" name="select_primary_hidden[]" value="<?php if($x == 1){ echo 'P'; } else { echo 'N'; } ?>">
                                    </div><?php */?>

                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 guestname_div">
                                        <label for="tax_name" class="form-label">Guest Name <span class="asterisk">* </span></label>
                                        <input type="text" class="form-control guest_name" name="guest_name[]" placeholder="Guest Name" required>                                
                                    </div>

                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                        <label for="tax_name" class="form-label"> Date of Birth <span class="asterisk"> <?php  if($x == 1) { ?>*<?php } ?> </span></label>
                                        <input type="date" class="form-control" name="guest_dob[]" <?php  if($x == 1) { ?> required <?php } ?> >                                
                                    </div>
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 guestgender_div">
                                        <label for="tax_name" class="form-label">Select Gender  <span class="asterisk"><?php  if($x == 1) { ?>*<?php } ?> </span></label>
                                        <select class="form-control guest_gender" name="guest_gender[]" <?php  if($x == 1) { ?> required <?php } ?> >
                                    ...
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 guestrelation_div">
                                        <label for="tax_name" class="form-label">Select relation <span class="asterisk guestrelation_asterisk"><?php  if($x == 1) { ?>*<?php } ?> </span></label>
                                        <select class="form-control guest_relation" name="guest_relation[]" <?php  if($x == 1) { ?> required <?php } ?> >
                                    ...
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 guestid_div">
                                        <label for="tax_name" class="form-label">Select ID Type <span class="asterisk guestid_asterisk">* </span></label>
                                        <select class="form-control guest_id" name="guest_id[]" required>
                                    ...
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 guestidentity_div">
                                        <label for="tax_name" class="form-label">Identity No. <span class="asterisk guestidentity_asterisk">* </span></label>
                                        <input type="text" class="form-control guest_id_number" name="guest_id_number[]" placeholder="Identity No." required>                                
                                    </div>
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 guestidfile_div">
                                        <label for="tax_name" class="form-label">ID Proof <span class="asterisk guestidfile_asterisk">* </span></label>
                                        <input type="file" class="form-control guest_id_file" name="guest_id_file[]" placeholder="" required>                                
                                    </div>

                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 address_div" <?php if($x == 1){ echo 'style="display: block;"'; } else { echo 'style="display: none;"'; } ?>>
                                        <label for="tax_name" class="form-label">Address <span class="asterisk address_asterisk">* </span></label>
                                        <input type="text" class="form-control guest_address" name="guest_address[]" placeholder="Address" <?php  if($x == 1) { ?> required <?php } ?>>                                    
                                    </div>
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 coming_div" <?php if($x == 1){ echo 'style="display: block;"'; } else { echo 'style="display: none;"'; } ?>>
                                        <label for="tax_name" class="form-label">Coming from <span class="asterisk coming_asterisk">* </span></label>
                                        <input type="text" class="form-control guest_from" name="guest_from[]" placeholder="Coming from" <?php  if($x == 1) { ?> required <?php } ?>>                                    
                                    </div>
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 going_div" <?php if($x == 1){ echo 'style="display: block;"'; } else { echo 'style="display: none;"'; } ?>>
                                        <label for="tax_name" class="form-label">Going to <span class="asterisk going_asterisk">* </span></label>
                                        <input type="text" class="form-control guest_to" name="guest_to[]" placeholder="Going to" <?php  if($x == 1) { ?> required <?php } ?>>                                    
                                    </div>
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 purpose_div" <?php if($x == 1){ echo 'style="display: block;"'; } else { echo 'style="display: none;"'; } ?>>
                                        <label for="tax_name" class="form-label">Purpose <span class="asterisk purpose_asterisk">* </span></label>
                                        <input type="text" class="form-control guest_purpose" name="guest_purpose[]" placeholder="Purpose" <?php  if($x == 1) { ?> required <?php } ?>>                                    
                                    </div>
                                    <div class="col-lg-4 col-sm-12 col-md-6 mb-3 contact_div" <?php if($x == 1){ echo 'style="display: block;"'; } else { echo 'style="display: none;"'; } ?>>
                                        <label for="tax_name" class="form-label">Contact No. <span class="asterisk contact_asterisk">* </span></label>
                                        <input type="text" class="form-control guest_contact" name="guest_contact[]" placeholder="Contact No." <?php  if($x == 1) { ?> required <?php } ?>>                                    
                                    </div>
                                    <?php /*?><div class="col-lg-4 col-sm-12 col-md-6 mb-3 aniver_div" <?php if($x == 1){ echo 'style="display: block;"'; } else { echo 'style="display: none;"'; } ?>>
