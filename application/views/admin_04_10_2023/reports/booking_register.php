            ...
            <div class="col-auto">
                <div class="page-utilities">
                    ...
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-6"><label class="pt-2" for="lblbookingsource">Booking Source</label></div>
                                    <div class="col-6">
                                        <select class="form-select" name="bookingsource" id="bookingsource">
                                            <option value="">--Select All--</option>
                                            <option value="B" <?php echo (set_value('bookingsource')=='B')?" selected=' selected'":""?>>Backend</option>
                                            <option value="F" <?php echo (set_value('bookingsource')=='F')?" selected=' selected'":""?>>Frontend</option>                             
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-5"><label class="pt-2" for="lblcanceledby">Canceled By</label></div>
                                    <div class="col-7">
