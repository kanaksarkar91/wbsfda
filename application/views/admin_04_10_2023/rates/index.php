                ...
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            ?>
                            <a class="btn app-btn-secondary" href="<?= base_url('admin/rates/add') ?>">
                                Add New Rate
                            </a>
                            <?php
                                }
                ...
                ?>
					...
					<input type="hidden" name="<?php echo $this->csrf['name']; ?>" value="<?php echo $this->csrf['hash']; ?>">
                        ...
                        <div class="col-lg-3 col-sm-12 col-md-6 mb-3 sec-btn">
                            ...
                            <a href="<?= base_url('admin/rates') ?>" class="btn btn-primary">Reset</a>
                        </div>
                    </form>
                    <div class="col-md-12">
                    ...
                    if(response.success){
                        ...
                        if(response.data.length > 0){
                            ...
                            $.each(response.data, function(index, data){
                                let edit = has_edit_access ? '<a class="btn-sm app-btn-secondary" href="'+base_url+'admin/rates/edit/'+data.rate_id+'">Edit</a>': '';
                                list +='<tr>\
