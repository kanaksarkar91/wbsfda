                ...
                <div class="app-card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="property_address_line_1" placeholder="Address Line 1" value="<?= $property['address_line_1']; ?>" required>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                <label for="property_city" class="form-label">City<span class="asterisk"> *</span></label>
                                <input type="text" class="form-control" name="property_city" placeholder="City" value="<?= $property['city']; ?>" required>
                            </div>
                            <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
...
var cur_lat="<?= !is_null($property['geo_latitude']) ? $property['geo_latitude'] : 0; ?>";
var cur_lng="<?= !is_null($property['geo_longitude']) ? $property['geo_longitude'] : 0; ?>";
