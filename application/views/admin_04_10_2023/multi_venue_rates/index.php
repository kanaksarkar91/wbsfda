                ...
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            ?>
                            <a class="btn app-btn-secondary" href="<?= base_url('admin/venue_rates/multi_add') ?>">
                                Add New Rate
                            </a>
                            <?php
                                }
                ...
                ?>
                    <form class="settings-form" id="rate-form" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="col-lg-3 col-sm-12 col-md-6 mb-3 sec-btn">
                            ...
                            <a href="<?= base_url('admin/venue_rates/multi_venue') ?>" class="btn btn-primary">Reset</a>
                        </div>
                    </form>
                    <div class="col-md-12">
                    ...
                    if(response.success){
                        ...
                        if(response.data.length > 0){
                            ...
                            $.each(response.data, function(index, data){
                                let edit = has_edit_access ? '<a href="'+base_url+'admin/venue_rates/multi_edit/'+data.rate_id+'/'+ data.property_id+'">Edit</a>': '';
                                list +='<tr>\
