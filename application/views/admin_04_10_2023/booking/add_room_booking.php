                            ...
                            <select class="form-select select2" id="customer_id" name="customer_id" required>
                                ...
                                <?php if (!empty($customer_list)) { ?>
                                    <?php foreach ($customer_list as $customer) { ?>
                                        <option value="<?php echo $customer['customer_id']; ?>" data-customer_data='<?= json_encode($customer) ?>'><?php echo $customer['first_name'] . ' ' . $customer['last_name'] . ' - ' . $customer['mobile'] ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
                        </div>
