...
.reserved:before {background: #ff2d00; width: 100%; height: 20px;content: '';position: absolute;left: 0;right: 0;}
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="app-card-body">
				...
				<input type="hidden" name="booking_id" value="<?php echo (isset($request_data))?$request_data['booking_id']:'';?>"  />
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                            ...
                            <input type="text" id="check_in_date" name="check_in_date" value="<?php echo (isset($request_data))?date('Y-m-d', strtotime($request_data['check_in'])):'';?>" class="form-control" readonly="">
                        </div>
                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                            <label for="check_out_date" class="form-label">Check Out <span class="asterisk"> *</span></label>
							<input type="text" id="check_out_date" name="check_out_date" value="<?php echo (isset($request_data))?date('Y-m-d', strtotime($request_data['check_out'])):'';?>" class="form-control" readonly="">
			...
			<input type="hidden" name="<?php echo $this->csrf['name']; ?>" value="<?php echo $this->csrf['hash']; ?>">
                ...
                <div class="app-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label for="tax_name" class="form-label">Select Customer </label>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Full Name" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['first_name']:'';?>" readonly="">

                                        </div>
                                        <?php /*?><div class="col-lg-4 col-sm-12 col-md-6 mb-3">
...
<script type="text/javascript">
    ...
    $('#book_room_submit').click(function() {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/booking/book_room_submit"); ?>',
            method: 'post',
            data: formData,
            dataType: 'json',
            processData: false,
    ...
    $(document).on('change', '#customer_id', function() {
        ...
        if (customer_id > 0) {
            ...
            $("#first_name").val(customer_data.first_name+' '+customer_data.last_name);
