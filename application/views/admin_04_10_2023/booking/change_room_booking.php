<div class="app-content pt-3 p-md-3 p-lg-3">
    ...
    <div class="container-xl search_select_room_div">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Change Room</h1>
            </div>
...
.reserved:before {background: #ff2d00; width: 100%; height: 20px;content: '';position: absolute;left: 0;right: 0;}
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="app-card-body">
                ...
                <form id="room_search_form" class="settings-form" method="post" action="#" enctype="" autocomplete="off">
				<input type="hidden" name="<?php echo $this->csrf['name']; ?>" value="<?php echo $this->csrf['hash']; ?>">
				<input type="hidden" name="booking_id" value="<?php echo (isset($request_data))?$request_data['booking_id']:'';?>" readonly=""  />
				<input type="hidden" name="booking_detail_id" value="<?php echo $booking_detail_id;?>" readonly=""  />

                    <div class="row g-3">

                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                            <label for="property_id" class="form-label">Property  <span class="asterisk"> *</span></label>
                            <select class="form-select select2" <?php if(!empty($request_data)){ ?> disabled="disabled" <?php } ?> >
							...
							<input type="hidden" name="property_id" id="property_id" value="<?php echo (isset($request_data))?$request_data['property_id']:'';?>"  />
                        </div>
                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                            <label for="check_in_date" class="form-label">Check In <span class="asterisk"> *</span></label>
                            <input type="text" id="check_in_date" name="check_in_date" value="<?php echo (isset($detail_request_data))?date('Y-m-d', strtotime($detail_request_data['in_date'])):'';?>" class="form-control" readonly="">
                        </div>
                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                            <label for="check_out_date" class="form-label">Check Out <span class="asterisk"> *</span></label>
							<input type="text" id="check_out_date" name="check_out_date" value="<?php echo (isset($detail_request_data))?date('Y-m-d', strtotime($detail_request_data['out_date'])):'';?>" class="form-control" readonly="">
                    ...
                    <div class="row g-3 add_room_div">
                        ...
                        <div class="col-lg-3 col-sm-12 col-md-6 mb-3">
							...
							<input type="text" name="adult[]" value="<?php echo (isset($request_data))?$request_data['adults']:'';?>" class="form-control" readonly="">
                        </div>
                        <div class="col-lg-3 col-sm-12 col-md-6 mb-3">
                            <label for="tax_name" class="form-label">Children </label>
							<input type="text" name="child[]" value="<?php echo (isset($request_data))?$request_data['children']:'';?>" class="form-control" readonly="">
                        </div>
                        <!-- <div class="col-md-2">
                        ...
                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
							...
							<select class="form-select select2 accommodation_id" name="accommodation_id[]">
                                ...
                                <?php foreach ($accommodations as $accommodation) { ?>
                                    <option value="<?= $accommodation['accommodation_id'] ?>"><?= $accommodation['accommodation_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>


                        <!--<div class="col-lg-2 col-sm-12 col-md-6 mb-3" style="margin-top: 45px;">
                    ...
                    <div class="col-md-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5 text-center">
                                <button id="continue_to_book_room" class="btn btn-green btn-continue">Continue</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xl book_room_div" style="display:none;">
            ...
            <div class="col-auto">
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        ...
                        <div class="col-auto">
                            <button class="btn app-btn-secondary" id="back_to_search_room">
                                Back
                            </button>
                        </div>
                    </div>
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <form id="room_book_form" class="settings-form" method="post" action="#" enctype="" autocomplete="off">
			<input type="hidden" name="<?php echo $this->csrf['name']; ?>" value="<?php echo $this->csrf['hash']; ?>">
                ...
                <div class="app-card-body">
                    <div class="row g-3">
                                ...
                                <table class="table app-table-hover mb-0 text-left" id="sports_facilities">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="font-weight:bold;font-size: 19px;">Discount (%) </td>  
                                            ...
                                            <td style="font-weight:bold;font-size: 19px;">Amount </td>
                                            <td style="font-weight:bold;font-size: 19px;">
                                                <input type="number" class="form-control discount_cls" id="discount_amount" name="discount_amount" data-type="amount" placeholder="Discount" min="0" step="1">
                                            </td>
                                            <td colspan="4"></td>
                        ...
                        <div class="col-md-12">
                            <label for="tax_name" class="form-label">Customer </label>
                            <select class="form-select select2" disabled="disabled">
                                <option value="">Search Customer Name Or Contact No</option>
                                <!-- <option value="">-----------------</option> -->
                                <?php if (!empty($customer_list)) { ?>
                                    <?php foreach ($customer_list as $customer) { ?>
                                        <option value="<?php echo $customer['customer_id']; ?>" <?= (isset($request_data['customer_id']) && $request_data['customer_id'] == $customer['customer_id']) ? 'selected' : '' ?> data-customer_data='<?= json_encode($customer) ?>'><?php echo $customer['first_name'] . ' ' . $customer['last_name'] . ' - ' . $customer['mobile'] ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
							
							<input type="hidden" id="customer_id" name="customer_id" value="<?php echo $request_data['customer_id'];?>" required />
                        </div>

                        <div class="Assign_Customer_Sec">
                            ...
                            <div id="Personal" style="display:block;">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            <label for="tax_name" class="form-label">Frist Name <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Frist Name" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['first_name']:'';?>" readonly="">

                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            <label for="tax_percentage" class="form-label">Last Name <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['last_name']:'';?>" readonly="">
                                        </div>

                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            <label for="cgst_percentage" class="form-label">Email Address <span class="asterisk"> *</span></label>
                                            <input type="email" class="form-control" id="email" name="email" placeholder="Email Address" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['email']:'';?>" readonly="">
                                        </div>

                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            <label for="sgst_percentage" class="form-label">Mobile No. <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile No" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['mobile']:'';?>" readonly="">
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="gst_number" name="gst_number" placeholder="GST Number" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['gst_number']:'';?>" readonly="">

                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            <label for="tax_percentage" class="form-label">Company Name <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Company Name" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['company_name']:'';?>" readonly="">
                                        </div>

                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            <label for="cgst_percentage" class="form-label">Business Email id </label>
                                            <input type="text" class="form-control" id="company_email" name="company_email" placeholder="Business Email id" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['company_email']:'';?>" readonly="">
                                        </div>
                                        <div class="col-lg-12 col-sm-12 col-md-6 mb-3">
                                            <label for="sgst_percentage" class="form-label">Company Address </label>
                                            <input type="text" class="form-control" id="company_address" name="company_address" placeholder="Company Address" value="<?php echo (isset($selected_customer_details))?$selected_customer_details['company_address']:'';?>" readonly="">
                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
                                            <label for="sgst_percentage" class="form-label">Phone No. <span class="asterisk"> *</span></label>
                                            <input type="text" class="form-control" id="company_phone" name="company_phone" placeholder="Phone No." value="<?php echo (isset($selected_customer_details))?$selected_customer_details['company_phone']:'';?>" readonly="">
                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-6 mb-3">
...
<script type="text/javascript">
    ...
    $('#property_id').change(function() {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/booking/getaccommodation"); ?>',
            method: 'post',
            data: {
    ...
    $('#search_room_btn').click(function() {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/booking/search_room"); ?>',
            method: 'post',
            data: formData,
            dataType: 'json',
            processData: false,
                ...
                if (response.status) {
                    ...
                    if (response.search_room_data.length > 0) {
                        ...
                        $.each(response.search_room_data, function(index, data) {
                            resultHTML += `<div class="col-md-12 mt-3">
                                        <h4><i class="fa fa-home"></i> Room ` + (index + 1) + `</h4>
                                        <hr>
                                    </div>
                                    <div class="col-md-12 room_details_row">
                                    ...
                                    <input type="hidden" name="select_tax_amount_base_price[]" value="` + data.tax_amount_base_price + `">
                                        ...
                                        <div class="card">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12"><h4>` + data.accommodation_name + ` <small>( ` + data.adult + ` Adult, ` + data.child + ` Child)  [Available: ` + data.no_of_accomm + `]</small></h4></div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="row room_dtl_sec">
                                                            <div class="col-md-6"><p>` + data.facilities + `</p></div>
                                                            <div class="col-md-3 price_sec">
                                                                <h4><i class="fa fa-inr"></i> ` + data.base_price + `</h4>
    ...
    $(document).on('change', '.select_room_qty', function() {
        ...
        $(".select_room_qty").each(function(index) {
            ...
            if (select_room_qty > 0) {
                ...
                select_room_HTML += `<li>
                        <h5>Room ` + room_no + ` (Qty : ` + select_room_qty + `)</h5><input type="hidden" id="selectedRoomQty" value="` + select_room_qty + `" />
    ...
    $("#continue_to_book_room").click(function() {
        ...
        var howMany = $('.room_item_list li').length;
		var selectedRoomQty = $('#selectedRoomQty').val();
		
		
		if(howMany == 1 && selectedRoomQty == 1){
			...
			if(howMany > 1){
				$.alert({
					title: 'Alert!',
					content: 'Please select only 1 accomodation to proceed!!',
					type: 'red',
					typeAnimated: true,
				});
			}
			else if(selectedRoomQty > 1){
				$.alert({
					title: 'Alert!',
					content: 'Please select only 1 room qty to proceed!!',
					type: 'red',
					typeAnimated: true,
				});
			}
                ...
                if (response.status) {
                    ...
                    if (response.search_room_data.length > 0) {
                        ...
                        $.each(response.search_room_data, function(index1, data) {
                            ...
                            var total_payable_amount = Number(base_price) + Number(tax_amount_base_price);
							...
							<input type="hidden" name="day_wise_rates_json[]" value="` + data.day_wise_rates_json + `">
										...
										<td>
											...
											<select class="form-select" name="room_number" id="room_number" required>
												...
												$.each(response.available_rooms,function(key,value) {
													book_room_HTML += `<option value="` + value.room_no + `">` + value.room_no + `</option>`;
												})
												book_room_HTML += `</select>
											
										</td>
                                        <td>` + select_room_qty + `</td>
                                        <th class="cell">` + parseFloat(disc_amt_on_base).toFixed(2) + `</th>
                                            <th class="cell">` + parseFloat(base_price).toFixed(2) + `</th>
                                            <th class="cell">` + parseFloat(tax_amount_base_price).toFixed(2) + `</th>
    ...
    $('#book_room_submit').click(function() {
        ...
        if (!$("#property_id").val()) {
            ...
            return false;
        } else if (!$("#room_number").val()) {
            $.alert({
                title: 'Alert!',
                content: 'Please select room no. to proceed',
                type: 'red',
                typeAnimated: true,
            })
            return false;
            ...
            return false;
        } else if ($("#customer_id").val() == 0 && (!$("#first_name").val() || !$("#last_name").val() || !$("#email").val() || !$("#mobile").val())) {

            $.alert({
                title: 'Alert!',
                content: 'First name, Last name, Email & Mobile is mandatory',
                type: 'red',
                typeAnimated: true,
            })
            return false;
        } else if ($("#customer_id").val() == 0 && $("#customer_type").val() == 'B' && (!$("#gst_number").val() || !$("#company_name").val())) {

            $.alert({
                title: 'Alert!', 
                content: 'GST Number, Company Name, Business Email id & Phone No. is mandatory',
                type: 'red',
                typeAnimated: true,
            })
            return false;
        ...
        $.ajax({
            url: '<?php echo base_url("admin/booking/change_room_submit"); ?>',
            method: 'post',
            data: formData,
            dataType: 'json',
            processData: false,
                        ...
                        buttons: {
                            ...
                            OK: {
                                ...
                                action: function() {
                                    ...
                                    window.location.href = response.rederict_link;
                                }
    ...
    $(document).on('change', '#customer_id', function() {
        ...
        if (customer_id > 0) {
            ...
            if (customer_data.customer_type == 'P') {
				...
				$("#customer_type_B").removeClass('active');
            } else {
                $("#Personal").show();
                $("#Business").hide();
                $("#customer_type_B").addClass('active');
				$("#customer_type_I").removeClass('active');
            }
