                ...
                <div class="app-card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 col-sm-12 col-md-6 mb-3">
                                ...
                                <select class="form-select other-option-allowed-adult" name="adult" id="adult" required>
                            ...
                            <div class="col-lg-6 col-sm-12 col-md-6 mb-3">
                                ...
                                <select class="form-select adult-option" name="child" required>
							...
							<div class="col-6">
								...
								<div class="table-responsive applicants-data-add-table" id="after_accommo_change_show">
									<table class="table table-sm align-middle table-bordered mb-0" id="myTableRoom">
										...
										?>
											<tr>
												<td><input type="text" class="form-control" name="room_no[]" id="room_no<?php echo $counter;?>" placeholder="Accommodation No." onchange="return check_room_no_availability(<?php echo $counter;?>);" required>
