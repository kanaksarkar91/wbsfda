        <div class="app-content pt-3 p-md-3 p-lg-3">
            ...
            <?php endif ?>
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">List HSN/SAC</h1>
                    </div>
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    ?>
                                    <a class="btn app-btn-primary" href="<?= base_url('admin/hsn_sac/add_hsn_sac'); ?>">
                                        ADD NEW HSN/SAC 
                                    </a>
                                    <?php
                                        }
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell">
                                            ...
                                            ?>
                                            <a class="btn-sm app-btn-secondary" href="<?= base_url('admin/hsn_sac/edit_hsn_sac/' . $hsn['hsn_sac_id']) ?>">Edit</a>
                                            <?php
                                                }
                                            ?>
