...
<div class="app-content pt-3 p-md-3 p-lg-3">
    <div class="container-xl">
            ...
            <div class="col-auto">
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <!--//col-->
                        <div class="col-auto">
                            <a class="btn app-btn-secondary" href="<?= base_url('admin/hsn_sac'); ?>">
                                VIEW ALL HSN/SAC  
                            </a>
                        </div>
                    </div>
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <form class="settings-form" method="post" action="<?= base_url('admin/hsn_sac/submit_hsn_sac'); ?>" enctype="multipart/form-data" autocomplete="off">
