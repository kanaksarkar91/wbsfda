                            ...
                            <table class="table app-table-hover mb-0 text-left" id="facilities_amenitis">
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo($facilities_amenitis['facility_type'] == 'R' ? 'Room' : ( $facilities_amenitis['facility_type'] == 'P' ? 'Property' : '') ); ?></td>
                                        ...
                                        ?>
                                            <a class="btn-sm app-btn-secondary" href="<?= base_url('admin/facilities_amenitis/editfacilities_amenitis/' . $facilities_amenitis['facility_id']) ?>">Edit</a>
                                        <?php
                                            }
                                        ?>
