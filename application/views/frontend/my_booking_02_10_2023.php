                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <div class="inner-booking-list d-flex">
                                                         ...
                                                         <?php if(($vd['booking_status'] == 1)){ ?>
                                                            <div class="inner-booking-list d-flex">
                                                                <span class="thm-txt fw-normal me-3">Paid Amount:</span>
                                                            <!--  <ul class="booking-list">
                                                                    <li class="highlighted"> --><span>₹ <?= $vd['advance_amount'] ?></span><!-- </li>
                                                                </ul> -->
                                                            </div>
                                                            <div class="inner-booking-list d-flex">
                                                                <span class="thm-txt fw-normal me-3">Due Amount:</span>
                                                            <!--  <ul class="booking-list">
                                                                    <li class="highlighted"> --><span>₹ <?=$vd['net_amount'] - $vd['advance_amount'] ?></span><!-- </li>
                                                                </ul> -->
                                                            </div>
                                                            <span class="thm-txt fw-normal me-3">Price:</span>
                                                        <!--  <ul class="booking-list">
                                                                <li class="highlighted"> --><span>₹ <?= $vd['net_amount'] ?></span><!-- </li>
                                                            </ul> -->
                                                        </div>
                                                        <?php } 
                                                        elseif(($vd['booking_status'] == 8)){if($vd['advance_amount']>0){ ?>
                                                            <div class="inner-booking-list d-flex">
                                                                <span class="thm-txt fw-normal me-3">Advance Amount:</span>
                                                            <!--  <ul class="booking-list">
                                                                    <li class="highlighted"> --><span>₹ <?= $vd['advance_amount'] ?></span><!-- </li>
                                                                </ul> -->
                                                            </div>
                                                        ...
                                                        <!--  <ul class="booking-list">
                                                                <li class="highlighted"> --><span><?=$vd['cancellation_reason']?></span><!-- </li>
                                                            </ul> -->
                                                        </div>
                                                        <?php } ?>
                                                        <?php if($vd['is_form_filledup'] == 1) {?>
                                                        <div class="inner-booking-list d-flex">
                                                            <span class="fw-bold text-success"><i class="las la-check-circle me-1"></i>Agency form submited.</span>
                                                        <!--  <ul class="booking-list">
                                                                <li class="highlighted"> --><!-- </li>
                                                            </ul> -->
                                                        </div>
                                                        <?php } ?>
                                                        <div class="mt-3">
                                                        <?php if($vd['is_form_filledup'] == 0) {?>
                                                         <button type="button" class="btn btn-sm btn-dark item-blinking submit_agency" data-bs-toggle="modal" data-id="<?= $vd['booking_id'] ?>">Add Agency Information</button>
                                                        ...
                                                        <a class="btn btn-sm btn-view-detail view_details" href="javascript:void(0)" data-booking_id="<?= $vd['booking_id']?>" >View Details</a>
                                                        ...
                                                        <?php if($vd['booking_status'] == '1'){ ?>
                                                            <button class="btn btn-sm btn-pay-now pay_now" data-booking_id = "<?= $vd['booking_id']?>" data-amount="<?= $vd['net_amount'] - $vd['advance_amount']?>">Pay Now</button>
                                                        <?php } ?>
                                                        <?php if($vd['booking_status'] == '8' && $vd['net_amount']>0){ ?>
                                                            <button class="btn btn-sm btn-pay-now pay_now" data-booking_id = "<?= $vd['booking_id']?>" data-amount="<?=($vd['advance_amount']>0)? $vd['advance_amount']:$vd['net_amount']?>">Pay Now</button>
                                                        <?php } ?>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="agencyModalLabel">Add Agency Information</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="padding: 10px;">
        <div id="agencyInformationBlock">            
            <form action="<?= base_url('frontend/venue_booking/submit_agency'); ?>" class="custom-form" id="agencyForm" autocomplete="off"  method="post">
            <div class="row g-2">
             <input type="hidden" name="<?= $this->csrf['name']; ?>" value="<?= $this->csrf['hash']; ?>">

             <input type="hidden" id="booking_id_agency" name="booking_id_agency">  
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <label for="" class="form-label">Name <span class="asterisk text-danger"> *</span></label>
                ...
                <div class="col-sm-12">
                    ...
                    <textarea class="form-control required-field" type="text" name="agency_full_address" id="agency_full_address" placeholder="Type Full Address" required></textarea>
                    <span class="validation-message text-danger hidden">Please enter the input field.</span>
                </div>
                <div class="col-sm-12">
...
$(document).ready(function() {    
    ...
    /*$(document).on('click','.view_details', function() {
     ...
     $(document).on('click', '.view_details', function() {
        ...
        $.ajax({
            url: '<?= base_url('frontend/venue_booking/myVenueBookingList');?>',
            method: 'POST',
...
function formatDate(dateString) {
 ...
 const urlParams = new URLSearchParams(window.location.search);
  ...
  $('#agencyForm').submit(function (e) {
            ...
            formData +='&<?= $this->security->get_csrf_token_name(); ?>='+ csrf_token;
