		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; margin-bottom:10px;">					
					...
					<tr>
						...
						<td colspan="3" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details['name'];?></td>
						<td style="background-color:#d9d9d9;padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;"><b>Gender </b></td>
						<td width="10%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details['gender'];?></td>
						...
						<td width="10%" style="border-bottom: #9e9e9e 1px solid;padding: 3px;"><?= ($primary_guest_details['age'] != '') ? $primary_guest_details['age'].' Years' : '';?></b></td>
					</tr>
					<tr>
						...
						<td width="21%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details['phone'];?></td>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; margin-top: 10px;">
					...
					<tr>
						...
						if($booking_payment_listing['payment_date'] == '' || $booking_payment_listing['payment_date'] == '0000-00-00'){
							...
							echo date('d/m/Y H:i:s',strtotime($booking_payment_listing['payment_date']));
						}
						?>
						</td>
