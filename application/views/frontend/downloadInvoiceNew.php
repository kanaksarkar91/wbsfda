            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid;">
                    <tr>
                        ...
                        <td width="18%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= ($booking_header['invoice_no'] != '') ? $booking_header['invoice_no'] : $booking_header['booking_id']; ?></td>
                    ...
                    <tr>
                        ...
                        <td width="20%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= date('d/m/Y', strtotime($booking_header['created_ts'])) ?></td>
                        ...
                        <td width="20%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $property_details['state_name'].' & 19'; ?></td>
					...
					<tr>
                        <td colspan="2" style="font-size:11px; background-color:#d9d9d9; padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: left;">Check-In Date & Time</td>
                        <td width="20%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= date('d/m/Y H:i:s', strtotime($check_in_out_details[0]->check_in_date_time));?></td>
                        <td colspan="2" style="font-size:11px; background-color:#d9d9d9; padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;">Check-Out Date & Time</td>
                        <td width="20%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= date('d/m/Y H:i:s', strtotime($check_in_out_details[0]->actual_checkout_time));?></td>
                    </tr>
                </table>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid;">
                    <tr>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid;">
                    ...
                    <tr>
						...
						<td colspan="3" width="43%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details[0]['name'];?></td>
						...
						<td width="15%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details[0]['gender'];?></td>
						...
						<td width="12%" style="border-bottom: #9e9e9e 1px solid;padding: 3px;"><?= ($primary_guest_details['age'] != '') ? $primary_guest_details[0]['age'].' Years' : '';?></td>
					</tr>
                    <tr>
						...
						<td width="15%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details[0]['phone'];?></td>
                    ...
                    <tr>
						...
						<td width="15%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;">Indian</td>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid;">
                    ...
                    <tr>
                        ...
                        <td width="25%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;" colspan="2">Accommodation Category</td>
					...
					?>
                    <tr>
                        <td width="5%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= ++$sl;?></td>
                        <td colspan="2" width="25%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?=$booking_detail['accommodation_name'];?></td>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid;">
					...
					?>
                    <tr>
                        <td width="5%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= ++$no;?></td>
                        <td width="15%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['room_charge'];?></td>
                        <td width="10%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['hsn_sac_code'];?></td>
                        <td width="7.5%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['room_sgst_percent'];?></td>
                        <td width="15%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['room_sgst'];?></td>
                        <td width="7.5%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['room_cgst_percent'];?></td>
                        <td width="15%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['room_cgst'];?></td>
                        <td width="10%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['room_igst'];?></td>
                        <td width="15%" style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $gstD['room_net_amount'];?></td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"></td>
                        <td style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"></td>
                        <td style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= number_format((float)$totalGst, 2, '.', '');?></td>
                        <td style="text-align: center; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= number_format((float)$totalPriceAfterGst, 2, '.', '');?></td>
                    </tr>
                </table>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                    <tr>
                        <td width="20%" style="text-align: left; padding: 3px;"><b>Total Invoice Value : </b></td>
                        <td width="80%" style="text-align: left; padding: 3px;">Indian Rupees <?= getIndianCurrencyNumberToWord($totalPriceAfterGst);?> </td>
                    </tr>
                </table>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                    <tr>
