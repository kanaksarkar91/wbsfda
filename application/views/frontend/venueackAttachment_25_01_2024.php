                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; font-size: 12px;">
                    <tbody>
                        ...
                        <tr style="font-size: 11px;">
                            ...
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>Base Amount</b></td>
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>Discount</b><br><small>(if any)</small></td>
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>Amount</b><br><small>(before GST)</small></td>
                            ...
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>CGST Rate(%)</b></td>
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>CGST</b><br><small>(Amount)</small></td>
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>SGST Rate(%)</b></td>
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>SGST</b><br><small>(Amount)</small></td>
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>GST </b><br><small>(Amount)</small></td>
                            <td width="9%" style="background-color:#d9d9d9;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>Amount Payable</b><br><small>(after GST)</small></td>
                        </tr>
						<?php foreach($booking_details[0]['booking_details'] as $bdetails){ ?>
							...
							<tr style="font-size: 11px;" class="bookingDetailsTR">
								...
								<td class="amountTD" width="9%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><?= number_format((float)($bdetails['rate'] - $bdetails['discount_amount']), 2, '.', ''); ?></td>
								...
								<td class="cgstamountTD" width="9%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><?= number_format((float)(($bdetails['v_cgst'] * ($bdetails['rate'] - $bdetails['discount_amount'])) / 100), 2, '.', ''); ?></td>
								...
								<td class="sgstamountTD" width="9%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><?= number_format((float)(($bdetails['v_sgst'] * ($bdetails['rate'] - $bdetails['discount_amount'])) / 100), 2, '.', ''); ?></td>
								<td class="gstamountTD" width="9%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><?= number_format((float)((($bdetails['v_cgst'] * ($bdetails['rate'] - $bdetails['discount_amount'])) / 100) + (($bdetails['v_sgst'] * ($bdetails['rate'] - $bdetails['discount_amount'])) / 100)), 2, '.', ''); ?></td>
                        ...
                        <tr style="font-size: 11px;">
                            ...
                            <td width="9%" style="background-color:#d9d9d9; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>&nbsp;</b></td>
                            <td class="totalsgstamountTD" width="9%" style="background-color:#d9d9d9; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>&nbsp;</b></td>
                            <td class="totalgstamountTD" width="9%" style="background-color:#d9d9d9; border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><b>&nbsp;</b></td>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; margin-top: 10px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="totaladvanceamountTD" style="padding: 3px;border-right: #9e9e9e 1px solid;text-align: right;"><?= $booking_details[0]['advance_amount']; ?></td>
                        </tr>
                    </tbody>
                </table>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; margin-top: 10px;">
