...
<script>
    ...
    function propertyResult(response) {
        ...
        $.each(propertyObj.result, function(key, value) {
            ...
            st += '<li><img src="<?= base_url(); ?>public/admin_assets/' + img + '" alt=""></li>';
            st += '<li><img src="<?= base_url(); ?>public/admin_assets/' + img2 + '" alt=""></li>';
            st += '<li><img src="<?= base_url(); ?>public/admin_assets/' + img3 + '" alt=""></li>';
            st += '</ul></div>';
            ...
            st += '<p class="destination_p">' + (value.property_desc != null ? (value.property_desc.substr(0, 100) + (value.property_desc.length > 100 ? '...' : '')) : '') + '</p>';
