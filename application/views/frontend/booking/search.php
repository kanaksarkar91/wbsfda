					...
					<div class="sidebar-widgets">
						...
						<div class="form-group">
							<div class="input-with-icon">
								...
								<input type="text" class="form-control check-in-out" name="checkIn" id="checkIn" value="<?= isset($from_date) && $from_date != '' ? $from_date : ''; ?>" readonly="" />
								<i class="ti-calendar"></i>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-with-icon">
								<input type="text" class="form-control check-in-out" name="checkOut" id="checkOut" value="<?= isset($to_date) && $to_date != '' ? $to_date : ''; ?>" readonly="" />
								<i class="ti-calendar"></i>
							</div>
						</div>
...
function propertyResult(response) {
	...
	$.each(propertyObj.result, function(key, value) {
		...
		st += '<div class="book_list_box popular_item"><div class="row g-0"><div class="col-lg-4 col-md-4">';/* <figure><img src="<?= base_url('public/admin_images/'); ?>' + img + '" class="img-fluid hotel-view-thumb hotel-view-list-thumb bg-image" alt="" /></figure></div>'; */
		st += '<div id="carouselExampleFade'+value.property_id+'" class="carousel slide carousel-fade">';
		st += '<div class="carousel-inner"><div class="carousel-item active"><img src="<?= base_url('public/admin_images/'); ?>' + img + '" class="d-block w-100" alt="..."></div>';
		st += '<div class="carousel-item"><img src="<?= base_url('public/admin_images/'); ?>' + img2 + '" class="d-block w-100" alt="..."></div>';
		st += '<div class="carousel-item"><img src="<?= base_url('public/admin_images/'); ?>' + img3 + '" class="d-block w-100" alt="..."></div>';
		st += '<div class="carousel-item"><img src="<?= base_url('public/admin_images/'); ?>' + img4 + '" class="d-block w-100" alt="..."></div>';
		st += '</div>';
		st += '<button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleFade'+value.property_id+'" data-bs-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="visually-hidden">Previous</span></button>';
		st += '<button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFade'+value.property_id+'" data-bs-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="visually-hidden">Next</span></button>';
		st += '</div></div>';
		st += '<div class="col-lg-6 col-md-5 px-3 side-br"><div class="book_list_header"><h4 class="book_list_title">' + value.property_name + '</h4><span class="location"><i class="ti-location-pin fs-6"></i>' + value.property_address + '</span></div><div class="book_list_description"><b class="thm-txt">Description:</b><p><i class="las la-arrow-circle-right fs-6 me-1"></i>' + (value.property_desc != null ? (value.property_desc.substr(0, 100) + (value.property_desc.length > 100 ? '...' : '')) : '') + '</p></div><div class="book_list_offers"><b class="thm-txt">Ameneties:</b><ul class="list-unstyled"><li><i class="las la-grin-stars fs-6 me-1"></i>' + value.facilities + '</li></ul></div></div><div class="col-lg-2 col-md-3 padd-l-0"><div class="book_list_foot"><span class="booking-time">Price starts from</span>';
