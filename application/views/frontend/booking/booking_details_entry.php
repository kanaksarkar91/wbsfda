                        ...
                        <div class="row">
							<div class="col-lg-12 col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input autocomplete="off" type="text" name="booking_fname" id="booking_fname" class="form-control text_capitalized">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input autocomplete="off" type="email" name="booking_email" id="booking_email" class="form-control">
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input autocomplete="off" type="number" name="booking_mobile" id="booking_mobile" class="form-control">
								</div>
							</div>
							...
							<?php
							if($property['property_id'] == 2 || $property['property_id'] == 3){//for oceana 1 & 2
							?>
							
							<div class="col-12">
							    <div class="form-group">
									<label>Additional Bed / Mattress required? <i class="req">*</i></label><br />
									<div class="form-check form-check-inline">
									  <input class="form-check-input" type="radio" name="additional_bed_mattress" id="addtionalbed1" value="No" checked="checked">
									  <label class="form-check-label" for="addtionalbed1">No</label>
									</div>
									<div class="form-check form-check-inline">
									  <input class="form-check-input" type="radio" name="additional_bed_mattress" id="addtionalbed2" value="Yes">
									  <label class="form-check-label" for="addtionalbed2">Yes</label>
									</div>
								</div>
							</div>
