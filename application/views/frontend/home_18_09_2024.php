								...
								<div class="banner-location-single w-100">
                                    <div class="banner-location-single-flex">
                                        <div class="banner-location-single-contents">
                                            ...
                                            <input type="text" class="form-control check-in-out" id="checkIn" value="<?= date('d/m/Y', strtotime('+1 day'));?>" readonly="" />
								...
								<div class="banner-location-single w-100">
                                    <div class="banner-location-single-flex">
                                        <div class="banner-location-single-contents">
                                            ...
                                            <input type="text" class="form-control check-in-out" id="checkOut" value="<?= date('d/m/Y', strtotime('+2 days'));?>" readonly="" />
