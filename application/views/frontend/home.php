		...
		<?php endif ?>
            <div class="col-12 col-lg-5 col-xl-4 order-2 order-lg-1 bg-white">
                <div class="details-contents-tab border">
                    ...
                    <ul class="tabs details-tab ms-3">                        
                        <li class="ms-0 active" data-tab="GusetHouse"> Guest House Accomodations </li>
                    ...
                    <div id="GusetHouse" class="tab-content-item active">
                        <form action="<?= base_url('frontend/booking/search/'); ?>" method="get" class="st-search-form-tour icon-frm withlbl banner-location-flex flex-column">
                            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
								...
								<div class="d-flex gap-3 banner-location-single w-100">
                                    <div class="banner-location-single-flex">
                                        <div class="banner-location-single-contents">
                                            <span class="banner-location-single-contents-subtitle"><i class="las la-calendar"></i> Check In </span>
                                            <input type="text" class="form-control form-select-lg check-in-out" id="checkIn" value="<?= date('d/m/Y', strtotime('+1 day'));?>" readonly="" />
											<input type="hidden" class="form-control check-in-out" name="checkindt" id="checkindt" value="<?= date('dmY', strtotime('+1 day'));?>" />
                                        </div>
                                    </div>
                                    <div class="banner-location-single-flex">
                                        <div class="banner-location-single-contents">
                                            <span class="banner-location-single-contents-subtitle"><i class="las la-calendar"></i> Check Out </span>
                                            <input type="text" class="form-control form-select-lg check-in-out" id="checkOut" value="<?= date('d/m/Y', strtotime('+2 days'));?>" readonly="" />
            ...
            <div class="col-12 col-lg-7 col-xl-8 order-1">
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="<?= base_url();?>public/frontend_assets/assets/img/slider/Digha-Fisheries-Project.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Digha Fisheries Project</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url();?>public/frontend_assets/assets/img/slider/Digha-Fisheries-Project-2.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Digha Fisheries Project</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url();?>public/frontend_assets/assets/img/slider/Shankarpur.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Shankarpur</h5>
                            </div>
                        </div>
                        ...
                        <?php foreach($exclusive_venues as $evenue){ ?>                            
                            ...
                            <div class="attraction-item">
                                <div class="single-attraction radius-20">
                                    ...
                                    <div class="single-attraction-thumb">
                                        <a href="<?= base_url('frontend/venue_booking/property_details/'); ?><?= $evenue['property_id']; ?>/<?= $evenue['rate_id']; ?>">
                                            <div id="carouselExampleControls<?= $j; ?>" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                                <div class="carousel-inner"> 
                                                    
                                                    <!--<?php if($evenue['image1'] || $evenue['image2'] || $evenue['image3'] || $evenue['image4']){ ?>

                                                        <?php if($evenue['image1']){                 

                                                            if($evenue['is_multiple_venues'] == 1){

                                                                $imG1 = explode(',', $evenue['image1']);
                                                                $i1 = 0;
                                                                foreach($imG1 as $imG){
                                                                    if($i1 == 0){
                                                                        $claSs = 'active';
                                                        ...
                                                        ?>
                                                                    <div class="carousel-item <?= $claSs; ?>"><img src="<?= base_url('/public/admin_images/'.$imG); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                                    $i1++;
                                                                }
                                                        ...
                                                        ?>
                                                                <div class="carousel-item active"><img src="<?= base_url('/public/admin_images/'.$evenue['image1']); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                            } 
                                                        ...
                                                        <?php if($evenue['image2']){                 

                                                            if($evenue['is_multiple_venues'] == 1){

                                                                $imG2 = explode(',', $evenue['image2']);
                                                                foreach($imG2 as $imG){
                                                        ?>
                                                                    <div class="carousel-item"><img src="<?= base_url('/public/admin_images/'.$imG); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                                }

                                                            } else {
                                                        ?>
                                                                <div class="carousel-item"><img src="<?= base_url('/public/admin_images/'.$evenue['image2']); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                            } 
                                                        ...
                                                        <?php if($evenue['image3']){                 

                                                            if($evenue['is_multiple_venues'] == 1){

                                                                $imG3 = explode(',', $evenue['image3']);
                                                                foreach($imG3 as $imG){
                                                        ?>
                                                                    <div class="carousel-item"><img src="<?= base_url('/public/admin_images/'.$imG); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                        ...
                                                        ?>
                                                                <div class="carousel-item"><img src="<?= base_url('/public/admin_images/'.$evenue['image3']); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                            } 
                                                        ...
                                                        <?php if($evenue['image4']){                 

                                                            if($evenue['is_multiple_venues'] == 1){

                                                                $imG4 = explode(',', $evenue['image4']);
                                                                foreach($imG4 as $imG){
                                                        ?>
                                                                    <div class="carousel-item"><img src="<?= base_url('/public/admin_images/'.$imG); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                        ...
                                                        ?>
                                                                <div class="carousel-item"><img src="<?= base_url('/public/admin_images/'.$evenue['image4']); ?>" class="d-block w-100" alt=""></div>
                                                        <?php
                                                            } 
                                                    ...
                                                    <?php if(!empty($evenue['venue_image'])){ ?>

                                                        <?php $i = 1; ?>

                                                        <?php foreach($evenue['venue_image'] as $vimage){ ?>
                                                            
                                                            <div class="carousel-item <?php if($i == 1){ ?> <?= 'active';?> <?php } ?>"><img src="<?=base_url('/public/admin_images/').$vimage['image_path'] ?>" class="d-block w-100" alt=""></div>
                                                ...
                                                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls<?= $j; ?>" data-bs-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="visually-hidden">Previous</span></button> <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls<?= $j; ?>" data-bs-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span><span class="visually-hidden">Next</span></button>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="single-attraction-contents">
                                        ...
                                        <ul class="mb-0 ps-0 list-unstyld single-attraction-contents-para"> 
                                            ...
                                            <li class="d-flex mb-1 small">
                                                ...
                                                <span><span class="hotel-view-contents-bottom-title">Rs. <?= $evenue['base_price']; ?></span> <?php if($evenue['is_hourly_booking_rate'] == 1){ ?> <?= ' for a duration of '.$evenue['booking_hours_rate'].' hours in a day';?> <?php } else { ?> <?= ' per calender day';?> <?php } ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="single-why-two bg-white single-why-two-border radius-10">
                        <div class="single-why-two-flex">
                            ...
                            <div class="single-why-two-contents">
                                <h4 class="single-why-two-contents-title"> <a href="javascript:void(0)"> Retail Fish Sale </a> </h4>
                                <p class="single-why-two-contents-para mt-2"> S.F.D.C LTD. has amplified its activities in sectors like retail fish marketing & has set up fisheries products outlets. </p>
                            </div>
                        </div>
                    </div>
                </div>
