        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; font-size: 12px;">
                    <tbody>
                        <tr>
                            <td colspan="<?php if($booking_details[0]['total_extra_hours'] > 0){ ?> <?= '12';?> <?php } else { ?> <?= '11';?> <?php } ?>" style="background-color:#d9d9d9;padding: 3px;border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;text-align: center;">
                                <b>Booking Details</b>
                            </td>
                        </tr>
						...
						<?php foreach($booking_details[0]['booking_details'] as $bdetails){ ?>
							...
							<tr style="font-size: 11px;" class="bookingDetailsTR">
                                ...
                                <?php if($booking_details[0]['total_extra_hours'] > 0){ ?>
                                    ...
                                    <td class="" width="7%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?php if(!empty($bdetails['extra_hours'])){ ?> <?= '1000 X '.$bdetails['extra_hours'].' = '.$bdetails['extra_rate'];?> <?php } else { ?> <?= '--';?> <?php } ?></td>

                                <?php } ?>

								<td class="discountpriceTD" width="9%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;text-align: right;"><?php if(!empty($bdetails['discount_amount'])){ ?> <?= $bdetails['discount_amount'];?> <?php } else { ?> <?= '0.00';?> <?php } ?></td>
		...
		<tr>
            ...
            <td style="padding: 10px;">
                ...
                <?php 
                    ...
                    $netAmount = $booking_details[0]['net_amount'];
                    $advanceAmount = $booking_details[0]['advance_amount'];
                    $gstAmount = $booking_details[0]['gst_amount'];
                ...
                <input type="hidden" id="paid_amount" name="paid_amount" value="<?= $advanceAmount; ?>">
