                                        ...
                                        <div id="individual" class="tab-content-item p-0 active">
                                            <div class="input-flex-item">
                                                <div class="single-input mt-3">
                                                    ...
                                                    <input class="form-control" type="text" name="indivisual_full_name"  id="indivisual_full_name" placeholder="Type Full Name"  value="<?= $customer_details['first_name']. ' '.  $customer_details['middle_name']. ' '.$customer_details['last_name']?>">
                                                </div>
                                                <div class="single-input mt-3">
                                                    <label class="label-title"> e-mail ID </label>
                                                    <input class="form-control" type="email" name="indivisual_email" id="indivisual_email" placeholder="Type Email-ID" value="<?= $customer_details['email'] ?>">
                                                </div>
                                                <div class="single-input mt-3">
                                                    <label class="label-title"> Contact No. </label>
                                                    <input class="form-control " type="text" name="indivisual_contact_no" id="indivisual_contact_no" placeholder="Type Contact No" value="<?= $customer_details['mobile'] ?>">
                                                </div>
                                            </div>
                                            <div class="input-flex-item">
                                                <div class="single-input mt-3">
