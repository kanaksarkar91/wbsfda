                                        ...
                                        <div id="individual" class="tab-content-item p-0 active">
                                            ...
                                            <div class="input-flex-item">
                                                <div class="single-input mt-3">
                                                    ...
                                                    <input class="form-control contact" type="text" name="indivisual_contact_no" id="indivisual_contact_no" placeholder="Type Contact No" value="<?= $customer_details['mobile'] ?>" readonly>
                                                </div>
                                                <div class="single-input mt-3">
                                        ...
                                        <div id="organisation" class="tab-content-item p-0">
                                            ...
                                            <div class="input-flex-item">
                                                ...
                                                <div class="single-input mt-3 gst-input-container">
                                                    ...
                                                    <div class="invalid-feedback"><span class="text-danger">Invalid GST No. Please enter a valid GST No.</span></div>
                                                </div>
                                            </div>
                                            <div class="input-flex-item">
                                                <div class="single-input mt-3">
