...
function propertyResult(response) {
	...
	$.each(propertyObj.result, function(key, value) {
        ...
        st += '<div class="btn-wrapper mt-4"><a href="' + lnk + '" class="cmn-btn btn-bg-1"> View Details </a><a href="check-availability-rates.html" class="cmn-btn btn-bg-1 ms-2"> Check Availability & Rates </a></div></div></div> </div></div>';
	});
