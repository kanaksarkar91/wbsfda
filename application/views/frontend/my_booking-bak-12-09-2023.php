                                            ...
                                            <div class="list-box-listing bookings">
                                                ...
                                                <div class="list-box-listing-content">
                                                    <div class="inner">
                                                        ...
                                                        <?php if($vd['booking_status'] == 4 ||$vd['booking_status'] == 8 ||$vd['booking_status'] == 2) {?>
                                                        <div class="inner-booking-list d-flex">
                                                            <span class="thm-txt fw-normal me-3">Reason:</span>
                                                        <!--  <ul class="booking-list">
                                                                <li class="highlighted"> --><span><?=($vd['booking_status'] == '4')? $vd['cancellation_reason']:(($vd['booking_status'] == '8')? $vd['revoked_reason']:(($vd['booking_status'] == '2')? $vd['rejection_reason'] :''))?></span><!-- </li>
                                                            </ul> -->
                                                        </div>
                                                        <?php } ?>
                                                        <div class="mt-3">
                    ...
                    <div class="modal-body" style="padding: 10px;">
                            ...
                            <h6 class="text-info mb-2">Details of the Reservee </h6>
                                <div class="row g-2">
                                    ...
                                    <div class="contact-person-info" style="display: none;">
     ...
     $(document).on('click', '.view_details', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const dateCell = $('<td class="cell text-center fw-bold">').text('Total Payable');
                const rateCell = $('<td class="cell text-right fw-bold" id="booking_amount"">').text(booking.net_amount);
                const row = $('<tr>');
                row.append(dateCell, rateCell);
                paymentDetailsBody.append(row);
