                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <div class="mt-3">
															...
															?> 
																...
																<!--<a target="_blank" class="btn btn-sm btn-danger" href="">Cancel Booking</a>-->
                                                            <?php } } ?>
                                                            ...
                                                            <a class="btn btn-sm btn-success" href="<?= base_url('download-invoice/' . encode_url($bd['booking_id'])) ?>" target="_blank"><i class="fa fa-download"></i> Download</a>
                                                                ...
                                                                <?php /*?><button type="button" class="btn btn-sm btn-info feed_back" data-booking_id="<?=$bd['booking_id']?>">Provide Feedback</button><?php */?>
                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <div class="inner-booking-list d-flex">
                                                            ...
                                                            <?php 
                                                                ...
                                                                //echo date('d-m-Y', strtotime($startDates[0]));
															?>                    
                                                        </div>
                                                         ...
                                                         <?php if(($vd['booking_status'] == 1)){ ?>
                                                            ...
                                                            <div class="inner-booking-list d-flex">
																...
																<span>₹ <?= number_format((float)($vd['net_amount'] - $vd['advance_amount']), 2, '.', ''); ?></span>
                                                            </div>
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <?php if(($vd['booking_status'] == '2' && $vd['net_amount']>0)||($vd['booking_status'] == '4' && $vd['net_amount']>0)||($vd['booking_status'] == '6' && $vd['net_amount']>0)) {?>
																...
																<a target="_blank" class="btn btn-sm btn-booking-slip" href="<?= base_url('frontend/profile/booking_invoice/'.encode_url($vd['booking_id'])) ?>">Invoice</a>
                                                            <?php } ?>
                                                            ...
                                                            <?php if(date('Y-m-d', strtotime($startDates[0])) > date('Y-m-d')){ ?>
                                                                <?php if(($vd['booking_status'] == '1' || $vd['booking_status'] == '2' || $vd['booking_status'] == '3' || $vd['booking_status'] == '4')){ ?>
                                                                    <a target="_blank" class="btn btn-sm btn-danger" href="<?= base_url('frontend/profile/venue_cancle_booking/' . encode_url($vd['booking_id'])).'?st='.$vd['booking_status']; ?>">Cancel Booking</a>
                                                                <?php } ?>
                                                            <?php } ?>

                                                            <input type="hidden" class="rateID" value="<?= $vd['rate_id']; ?>">
        ...
        <div id="agencyInformationBlock">            
            ...
            <div class="row g-2">
             ...
             <input type="hidden" id="booking_id_agency" name="booking_id_agency">  
				...
				<div class="col-sm-12 col-md-6 col-lg-6">
					...
					<select class="form-control required-field" name="agency_event_type" id="agency_event_type" required>
                        <option value="">Select Event Type</option>
                            <?php foreach($venue_event_types as $evType){ ?>
                                <option value="<?= $evType['event_type_id']; ?>"><?= $evType['event_type_name']; ?></option>
                            <?php } ?>
                        </select>
                    <span class="validation-message text-danger hidden">Please enter the input field.</span>
                </div>
                ...
                <div class="col-sm-12 otherDiv" style="display: none;">
                    <label class="form-label"> Other Event Type <span class="asterisk text-danger"> *</span></label>
                    <input class="form-control required-field" type="text" name="other_event_type" id="other_event_type" placeholder="Other Event Type">
                </div>
...
<div>
    ...
    <input type="hidden" name="payment_rate_id" id="payment_rate_id" value="">
...
$(document).ready(function() { 
    ...
    $("#agency_event_type").on("change", function() {
...
function formatDate(dateString) {
 ...
 const urlParams = new URLSearchParams(window.location.search);
   ...
   $(document).on('click', '.pay_now', function(e) {
        ...
        let rateId = $(this).closest('div').find('.rateID').val();
        var csrf_token = "<?= $this->security->get_csrf_hash(); ?>";
