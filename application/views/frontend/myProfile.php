                ...
                <div class="dashboard-navbar dashboard-left-content">
                    ...
                    <div class="d-navigation"> 
                        <ul class="dashboard-list list-style-none">
                            <li class="list active"><a href="<?= base_url('my-profile') ?>"><i class="ti-user"></i> My Profile</a></li>
                            <li class="list"><a href="<?= base_url('my-booking')?>"><i class="ti-layers"></i> My Booking</a></li>
                            ...
                            <div class="submit-section">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control text_capitalized" name="first_name" value="<?= $customer_details['first_name'].' '.$customer_details['last_name']; ?>">
                                    </div>
