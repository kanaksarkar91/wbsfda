...
<body role="document">
    <?php if($booking_slip['status'] == '6'){ ?>
        <div class="waterMark" style="position: absolute; top: 170px; left: 580px; z-index: 99; opacity: 0.2;"><img src="https://wbsfdc.devserv.in/public/frontend_assets/images/cancle.png"></div>
    <?php } ?>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; text-align:left;">
                    ...
                    <tr>
                        ...
                        <td width="20%" style="font-size:11px; border-bottom: #9e9e9e 1px solid;padding: 3px;"><?php if($booking_slip['booking_from'] == 'C'){ echo 'Website (Booked By:'.$booking_slip['online_bookedby'].')'; } else { echo 'Admin (Booked By:'.$booking_slip['offline_bookedby'].')'; } ?></td>
                    </tr>
                </table>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; text-align:left;">
                    <tr>
