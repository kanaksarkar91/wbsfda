                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; text-align:left;margin-top: 3px;">
                    ...
                    ?>
                            <tr>
                                ...
                                <td width="" style="font-size:12px; padding: 6px 3px; text-align: center; border-top: #9e9e9e 1px solid; border-right: #9e9e9e 1px solid;"><?= (($booking_detail['gst_perc'] > 0) ? ($booking_detail['gst_perc'] / 2) . '%' : 'N/A') ?></td>
                    ...
                    <?php
                            ...
                            $totalGSTAmount += $booking_detail['room_gst_amt'];
                            $totalPayableAmount += $booking_detail['room_net_amount'] + $booking_detail['room_gst_amt'];
                        }
                    }
                    ?>
