            ...
            <td>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid;">
                    ...
                    <tr>
						...
						<td colspan="3" width="43%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details['name'];?></td>
						...
						<td width="15%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details['gender'];?></td>
						...
						<td width="12%" style="border-bottom: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details['age'];?> &nbsp;Years</td>
					</tr>
                    <tr>
						...
						<td width="15%" style="border-bottom: #9e9e9e 1px solid;border-right: #9e9e9e 1px solid;padding: 3px;"><?= $primary_guest_details['phone'];?></td>
