            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;border: #9e9e9e 1px solid; text-align:center;margin-top: 3px;">
                    ...
                    <tr>
                        ...
                        <td width="16%" style="font-size:12px;  border-right: #9e9e9e 1px solid;padding: 6px 3px; text-align: left;"><?=$property_details['checkin_time']. ' Hrs'; ?></td>
                        ...
                        <td width="16%" style="font-size:12px;  padding: 6px 3px;"><?=$property_details['checkout_time']. ' Hrs'; ?></td>
                    </tr>
                </table>
            </td>
        </tr>
