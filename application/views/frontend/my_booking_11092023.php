            ...
            <div class="col-lg-9 col-md-8 col-sm-12">
                <div class="dashboard-wraper single-reservation bg-white base-padding">
                                                ...
                                                <div class="list-box-listing-content">
                                                    <div class="inner">
                                                        ...
                                                        <div class="inner-booking-list d-flex">
                                                            ...
                                                            <!-- <ul class="booking-list">
                                                                <li class="highlighted"> --><span><?= date('d-m-Y', strtotime($bd['check_in'])) ?> to <?= date('d-m-Y', strtotime($vd['check_out'])) ?></span><!-- </li> -->
                                                            <!-- </ul> -->
                                                        </div>
                                                        <div class="inner-booking-list d-flex">
                    ...
                    <div class="dashboard-gravity-list mt-3">
                            <ul>
                                <?php
                                if (!empty($venue_bookings)) {
                                    foreach ($venue_bookings as $vd) { ?>
                                        <li class="pending-booking mb-3">
                                            <div class="list-box-listing bookings">
                                                ...
                                                <div class="list-box-listing-content">
                                                    <div class="inner">
                                                        <h3><?= $vd['venue_names'] ?> <span class="<?= (($vd['booking_status'] == 1) ? 'badge rounded-pill request-approved' : (($vd['booking_status'] == 2)?'badge rounded-pill request-reject':(($vd['booking_status'] == 3)?'badge rounded-pill status-confirmed':(($vd['booking_status'] == 4)?'badge rounded-pill status-cancelled':(($vd['booking_status'] == 5)?'badge rounded-pill approval-expired':(($vd['booking_status'] == 6)?'badge rounded-pill paid-not-confirm':(($vd['booking_status'] == 7)?'badge rounded-pill request-expire':(($vd['booking_status'] == 8)?'badge rounded-pill approval-revoke':'badge rounded-pill request-waiting')))))))) ?>"><?= ($vd['booking_status'] == 1) ? 'Request Approved' : (($vd['booking_status'] == 2)?'Request Rejected':(($vd['booking_status'] == 3)?'Confirmed':(($vd['booking_status'] == 4)?'Cancelled':(($vd['booking_status'] == 5)?'Approval Expired':(($vd['booking_status'] == 6)?'Paid But Not Confirmed':(($vd['booking_status'] == 7)?'Request Expired':(($vd['booking_status'] == 8)?'Approval Revoked':'Request In Waiting'))))))) ?></span>
                                                        </h3>
                                                        ...
                                                        <div class="inner-booking-list d-flex">
                                                            <span class="thm-txt fw-normal me-3">Booking No.:</span>
                                                            <!-- <ul class="booking-list">
                                                                <li class="highlighted"> --><span><?= $vd['booking_id']; ?></span><!-- </li> -->
                                                            <!-- </ul> -->
                                                        </div>
    
                                                        <div class="inner-booking-list d-flex">
                                                            <span class="thm-txt fw-normal me-3">Booking Date:</span>
                                                            <?php if (isset($vd['booking_details']) && is_array($vd['booking_details'])) {
                                                        ...
                                                        <div class="inner-booking-list d-flex">
                                                            <span class="thm-txt fw-normal me-3">Price:</span>
                                                        <!--  <ul class="booking-list">
                                                                <li class="highlighted"> --><span>₹ <?= $vd['total_rate'] ?></span><!-- </li>
                                                            </ul> -->
                                                        </div>
                                                        <div class="inner-booking-list d-flex">
                                                            <span class="thm-txt fw-normal me-3">Reason:</span>
                                                        <!--  <ul class="booking-list">
                                                                <li class="highlighted"> --><span>Lorem ipsum dummy text lorem ipsum dummy text</span><!-- </li>
                                                            </ul> -->
                                                        </div>
                                                        <div class="mt-3">
                                                        ...
                                                        <a class="btn btn-sm btn-view-detail view_details" href="javascript:void(0)" data-booking_id="<?= $vd['booking_id']?>" data-venue_name="<?= $vd['venue_names']?>" data-location_name="<?= $vd['property_name']?>" data-created_at="<?= date('d-m-Y H:i:s',strtotime($vd['created_at']))?>" data-total_rate="<?= $vd['total_rate']?>" data-organization_name="<?= ($vd['is_indivisual']==1)? $vd['indivisual_full_name'] :  $vd['business_full_name'] ?>" data-mailing_address="<?= ($vd['is_indivisual']==1)? $vd['indivisual_full_address'] :  $vd['business_full_address'] ?>" data-contact_no="<?= ($vd['is_indivisual']==1)? $vd['indivisual_contact_no'] :  $vd['business_contact_no'] ?>" data-email="<?= ($vd['is_indivisual']==1)? $vd['indivisual_email'] :  $vd['business_email'] ?>" data-contact_person="<?= $vd['contact_person_name'] ?>" data-designation="<?=$vd['contact_person_designation'] ?>" data-reservation_date = "<?= implode(', ',$booking_date)?>" >View Details</a>
                                                            ...
                                                            <?php if($vd['booking_status'] == '3'|| $vd['booking_status'] == '6') {?>
                                                                <a target="_blank" class="btn btn-sm btn-booking-slip" href="<?= base_url('frontend/venue_booking/booking_slip/'.$vd['booking_id']) ?>">Booking Slip</a>
                                                            <?php } ?>

                                                            <?php if($vd['booking_status'] == '3') {?>
                                                                <a target="_blank" class="btn btn-sm btn-NOC-letter" href="<?= base_url($vd['noc_file_path']) ?>">NOC Letter</a>
                                                            <?php } ?>

                                                        <?php if(($vd['booking_status'] == '1') && ($vd['payment_method'] == 'Online')){ ?>
                                                            <button class="btn btn-sm btn-pay-now pay_now" data-booking_id = "<?= $vd['booking_id']?>" data-amount="<?= $vd['net_amount']?>">Pay Now</button>
                                                        <?php } ?>
                        ...
                        <tr>
                            ...
                            <h6 class="text-info mb-2">Venue Details</h6>
                                <div class="row g-2">
                                    <div class="col-sm-12 col-md-4 col-lg-3">
                                        ...
                                        <input type="text" class="form-control" value="NALBAN FOOD PARK" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-8 col-lg-9">
                                        <label for="" class="form-label">Venue Name</label>
                                        <input type="text" class="form-control" value="Red Fort Hall with AC (area 893 sq. ft.)  " readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-4 col-lg-3">
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-5">
                                        ...
                                        <input type="text" class="form-control" value="08-09-2023 13:29:28" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-4 col-lg-4">
                                        <label for="" class="form-label">Booking Amount</label>
                                        <input type="text" class="form-control" value="14000.00" readonly="">
                                    </div>
                                </div>

                            <hr>
                            <h6 class="text-info mb-2">Details of the Reservee </h6>
                                <div class="row g-2">
                                    <div class="col-sm-12 col-md-4">
                                        <label for="" class="form-label">Business Name </label>
                                        <input type="text" class="form-control" value="Syscentric Technologies Pvt. Ltd." readonly="">
                                    </div>                                    
                                    <div class="col-sm-12 col-md-4">                                        
                                        <label for="" class="form-label">Contact No.</label>
                                        <input type="text" class="form-control" value="9432820202" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <label for="" class="form-label">e-mail ID</label>
                                        <input type="email" class="form-control" value="paulshan09@gmail.com" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <label for="" class="form-label">Mailing Address with PIN Code </label>
                                        <textarea class="form-control" name="" id="" cols="" rows="3" readonly="">kolkata</textarea>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" value="Santanu Paul" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <label for="" class="form-label">Contact No.</label>
                                        <input type="number" class="form-control" value="7898999999" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <label for="" class="form-label">e-mail ID</label>
                                        <input type="number" class="form-control" value="paulshan09@gmail.com" readonly="">
                                    </div>
                            ...
                            <h6 class="text-info mb-2">Agency Details </h6>
                                <div class="row g-2">
                                    <div class="col-sm-12 col-md-4">
                                        <label for="" class="form-label">Name </label>
                                        <input type="text" class="form-control" value="Test Vendor" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <label for="" class="form-label">Contact No.</label>
                                        <input type="text" class="form-control" value="6773737387" readonly="">
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <label for="" class="form-label">e-mail ID</label>
                                        <input type="email" class="form-control" value="test@gmail.com" readonly="">
                                    </div>                                    
                                    <div class="col-sm-12 col-md-8">
                                        <label for="" class="form-label">Mailing Address with PIN Code </label>
                                        <textarea class="form-control" name="" id="" cols="" rows="2" readonly="">877112</textarea>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-bordered app-table-hover mb-0 text-left">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="cell text-center">16-09-2023 </td>
                                                        <td class="cell text-right">7000.00 </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="cell text-center">18-09-2023 </td>
                                                        <td class="cell text-right">7000.00 </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="cell text-center"><b>Total Payable</b></td>
                                                        <td class="cell text-right fw-bold">14000.00 </td>
                                                        <input type="hidden" class="form-control" id="total_rate" name="total_rate" value="14000.00">
                                                        <input type="hidden" class="form-control" id="net_amount" name="net_amount" value="NaN">
                                                    </tr>
                                                </tbody>
                                            </table> 
                                        </div>
...
$(document).ready(function() {
 ...
 const urlParams = new URLSearchParams(window.location.search);
       ...
       $('.nav-link').on('click', function() {
            ...
            const url = '<?= base_url('my-booking');?>'+ '?tab=' + tabType;
