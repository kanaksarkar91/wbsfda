...
class Tax extends MY_Controller
{
	...
	{
		if($this->input->post()){
			$this->form_validation->set_rules('tax_name','Tax Name','trim|required|callback_check_textbox_with_some_special_character');
			...
			$this->form_validation->set_rules('tax_status', 'Status', 'trim|required|in_list[1,0]');
